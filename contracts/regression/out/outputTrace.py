...
Not(And([Or(j != xa_q, aw_q0[j] > aw[i][j]) for j in range(A+1)]))
        )))))
...
Not(And([Or(j != xa_q, aw_q1[j] > aw[i][j]) for j in range(A+1)]))
        )))))
...
Not(And([Or(j != xa_q, aw_q2[j] > aw[i][j]) for j in range(A+1)]))
        )))))
...
Not(And([Or(j != xa_q, aw_q3[j] > aw[i][j]) for j in range(A+1)]))
        )))))
...
Not(And([Or(j != xa_q, aw_q4[j] > aw[i][j]) for j in range(A+1)]))
        )))))

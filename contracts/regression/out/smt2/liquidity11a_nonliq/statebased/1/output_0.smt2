...
(assert
 (let (($x294 (exists ((xa_q Int) )(let (($x292 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (pay_amount0_q Int) )(let (($x405 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_2_0 w_2)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_2_1 w_2)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_2_2 w_2)))))))
 (let (($x461 (= awq0_2 aw_2_2)))
 (let (($x462 (= awq0_1 aw_2_1)))
 (let (($x463 (= awq0_0 aw_2_0)))
 (let (($x464 (and $x463 $x462 $x461)))
 (let (($x358 (= wq0 t_wq0_0)))
 (let (($x367 (and $x358 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2)))))
 (let (($x411 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_2_0 pay_amount0_q)) (= t_awq0_0_0 aw_2_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_2_1 pay_amount0_q)) (= t_awq0_0_1 aw_2_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_2_2 pay_amount0_q)) (= t_awq0_0_2 aw_2_2)))))
 (let (($x486 (= wq0 w_2)))
 (let (($x487 (and $x486 $x464)))
 (let (($x387 (>= pay_amount0_q 0)))
 (let (($x388 (not $x387)))
 (let (($x379 (and (ite $x388 $x487 (and (and (= t_wq0_0 (- w_2 pay_amount0_q)) $x411) true)))))
 (let (($x469 (= t_awq0_0_2 aw_2_2)))
 (let (($x257 (= xa_q 2)))
 (let (($x473 (= t_awq0_0_1 aw_2_1)))
 (let (($x246 (= xa_q 1)))
 (let (($x477 (= t_awq0_0_0 aw_2_0)))
 (let (($x248 (= xa_q 0)))
 (let (($x415 (and (ite $x248 (= t_awq0_0_0 (+ aw_2_0 (- pay_amount0_q 1))) $x477) (ite $x246 (= t_awq0_0_1 (+ aw_2_1 (- pay_amount0_q 1))) $x473) (ite $x257 (= t_awq0_0_2 (+ aw_2_2 (- pay_amount0_q 1))) $x469))))
 (let (($x407 (not (>= (- pay_amount0_q 1) 0))))
 (let (($x421 (ite $x407 $x487 (and (and (= t_wq0_0 (- w_2 (- pay_amount0_q 1))) $x415) true))))
 (let (($x272 (and $x248)))
 (let (($x349 (ite (not (<= pay_amount0_q w_2)) $x487 (and (and (ite $x272 (and $x421) $x379) true $x367)))))
 (let (($x417 (= xn_q0 0)))
 (let (($x418 (not $x417)))
 (let (($x420 (= f_q0 pay)))
 (let (($x426 (ite $x420 (ite $x418 $x487 (and $x349)) (and (= t_wq0_0 (+ w_2 xn_q0)) (and $x358 $x464)))))
 (let (($x422 (>= xn_q0 0)))
 (let (($x280 (<= xa_q 2)))
 (let (($x281 (>= xa_q 0)))
 (let (($x282 (and $x281 $x280 $x422)))
 (let (($x427 (and $x282 (and (>= aw_2_0 0) (>= aw_2_1 0) (>= aw_2_2 0)) (>= block_num_2 block_num_2) $x426)))
 (or (not $x427) $x405)))))))))))))))))))))))))))))))))))
 ))
 (let (($x287 (<= xa_q 2)))
 (let (($x387 (>= xa_q 0)))

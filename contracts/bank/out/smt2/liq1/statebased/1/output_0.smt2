...
(assert
 (let (($x420 (exists ((xa_q Int) )(let (($x414 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (withdraw_amount0_q Int) (myBalancesq0_0 Int) (myBalancesq0_1 Int) (myBalancesq0_2 Int) (t_myBalancesq0_0_0 Int) (t_myBalancesq0_0_1 Int) (t_myBalancesq0_0_2 Int) )(let (($x330 (and (distinct xa_q 2) true)))
 (let (($x332 (and (distinct xa_q 1) true)))
 (let (($x334 (and (distinct xa_q 0) true)))
 (let (($x577 (and (or $x334 (not (>= (- awq0_0 aw_2_0) myBalances_2_0))) (or $x332 (not (>= (- awq0_1 aw_2_1) myBalances_2_1))) (or $x330 (not (>= (- awq0_2 aw_2_2) myBalances_2_2))))))
 (let (($x630 (= myBalances_2_2 myBalancesq0_2)))
 (let (($x631 (= myBalances_2_1 myBalancesq0_1)))
 (let (($x632 (= myBalances_2_0 myBalancesq0_0)))
 (let (($x633 (and $x632 $x631 $x630)))
 (let (($x634 (= awq0_2 aw_2_2)))
 (let (($x635 (= awq0_1 aw_2_1)))
 (let (($x636 (= awq0_0 aw_2_0)))
 (let (($x637 (and $x636 $x635 $x634)))
 (let (($x488 (= wq0 t_wq0_0)))
 (let (($x640 (= t_wq0_0 (+ w_2 xn_q0))))
 ...
 (let (($x546 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_2_0 withdraw_amount0_q)) (= t_awq0_0_0 aw_2_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_2_1 withdraw_amount0_q)) (= t_awq0_0_1 aw_2_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_2_2 withdraw_amount0_q)) (= t_awq0_0_2 aw_2_2)))))
 (let (($x659 (= wq0 w_2)))
 (let (($x660 (and $x659 $x637 $x633)))
 (let (($x521 (>= withdraw_amount0_q 0)))
 (let (($x522 (not $x521)))
 (let (($x337 (= xa_q 2)))
 (let (($x536 (or $x337 (= t_myBalancesq0_0_2 myBalances_2_2))))
 (let (($x339 (= xa_q 1)))
 (let (($x533 (or $x339 (= t_myBalancesq0_0_1 myBalances_2_1))))
 (let (($x341 (= xa_q 0)))
 (let (($x540 (or $x341 (= t_myBalancesq0_0_0 myBalances_2_0))))
 (let (($x513 (and $x540 $x533 $x536)))
 (let (($x523 (and (or $x334 (= t_myBalancesq0_0_0 (- myBalances_2_0 withdraw_amount0_q))) (or $x332 (= t_myBalancesq0_0_1 (- myBalances_2_1 withdraw_amount0_q))) (or $x330 (= t_myBalancesq0_0_2 (- myBalances_2_2 withdraw_amount0_q))))))
 (let (($x543 (and (and $x523 $x513) (ite $x522 $x660 (and (and (= t_wq0_0 (- w_2 withdraw_amount0_q)) $x546) true $x501)))))
 (let (($x559 (and (or $x334 (<= withdraw_amount0_q myBalances_2_0)) (or $x332 (<= withdraw_amount0_q myBalances_2_1)) (or $x330 (<= withdraw_amount0_q myBalances_2_2)))))
 (let (($x583 (and (and (ite (not $x559) $x660 (and (and $x543 true $x501))) true $x501))))
 (let (($x557 (not (> withdraw_amount0_q 0))))
 (let (($x560 (= xn_q0 0)))
 (let (($x561 (not $x560)))
 (let (($x563 (= f_q0 withdraw)))
 (let (($x470 (ite $x563 (ite $x561 $x660 (and (ite $x557 $x660 $x583))) (and $x640 (and $x488 $x637 $x633)))))
 (let (($x406 (and (or $x334 (= t_myBalancesq0_0_0 (+ myBalances_2_0 xn_q0))) (or $x332 (= t_myBalancesq0_0_1 (+ myBalances_2_1 xn_q0))) (or $x330 (= t_myBalancesq0_0_2 (+ myBalances_2_2 xn_q0))))))
 (let (($x579 (= f_q0 deposit)))
 (let (($x410 (ite $x579 (and $x640 (and (and $x406 $x513) true (and $x488 $x637 $x496))) $x470)))
 (let (($x581 (>= xn_q0 0)))
 (let (($x388 (<= xa_q 2)))
 (let (($x389 (>= xa_q 0)))
 (let (($x390 (and $x389 $x388 $x581)))
 (let (($x411 (and $x390 (and (>= aw_2_0 0) (>= aw_2_1 0) (>= aw_2_2 0)) (>= block_num_2 block_num_2) $x410)))
 (or (not $x411) $x577))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x418 (and (or (and (distinct xa_q 0) true) (> myBalances_2_0 0)) (or (and (distinct xa_q 1) true) (> myBalances_2_1 0)) (or (and (distinct xa_q 2) true) (> myBalances_2_2 0)))))
 (let (($x373 (<= xa_q 2)))
 (let (($x374 (>= xa_q 0)))

...
(assert
 (let (($x602 (exists ((xa_q Int) )(let (($x1143 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_wq0_1 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (t_awq0_1_0 Int) (t_awq0_1_1 Int) (t_awq0_1_2 Int) (win_winner0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) (t_oracleq0_1 Int) (deadlineq0 Int) (t_deadlineq0_0 Int) (t_deadlineq0_1 Int) (par1q0 Int) (t_par1q0_0 Int) (t_par1q0_1 Int) (par2q0 Int) (t_par2q0_0 Int) (t_par2q0_1 Int) (stateq0 Int) (t_stateq0_0 Int) (t_stateq0_1 Int) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_wq1_1 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (t_awq1_1_0 Int) (t_awq1_1_1 Int) (t_awq1_1_2 Int) (win_winner1_q Int) (oracleq1 Int) (t_oracleq1_0 Int) (t_oracleq1_1 Int) (deadlineq1 Int) (t_deadlineq1_0 Int) (t_deadlineq1_1 Int) (par1q1 Int) (t_par1q1_0 Int) (t_par1q1_1 Int) (par2q1 Int) (t_par2q1_0 Int) (t_par2q1_1 Int) (stateq1 Int) (t_stateq1_0 Int) (t_stateq1_1 Int) )(let (($x801 (and (or (and (distinct par2_1 0) true) (not (>= (- awq1_0 aw_1_0) 2))) (or (and (distinct par2_1 1) true) (not (>= (- awq1_1 aw_1_1) 2))) (or (and (distinct par2_1 2) true) (not (>= (- awq1_2 aw_1_2) 2))))))
 (let (($x805 (and (or (and (distinct par1_1 0) true) (not (>= (- awq1_0 aw_1_0) 2))) (or (and (distinct par1_1 1) true) (not (>= (- awq1_1 aw_1_1) 2))) (or (and (distinct par1_1 2) true) (not (>= (- awq1_2 aw_1_2) 2))))))
 ...
 (let (($x1198 (and (and $x866 (ite (not (>= block_num_1 deadlineq0)) $x1168 $x1193)) true $x1157)))
 ...
 (let (($x1240 (ite (not (= oracle_1 oracleq0)) $x1168 (and (and (ite (not (< block_num_1 deadlineq0)) $x1168 $x1232) true $x1206)))))
 ...
 (let (($x1253 (ite (not (and (distinct oracle_1 par1q0) true)) $x1168 (and (and (= t_par2q1_0 oracle_1) true $x1248)))))
 (let (($x925 (= xn_q1 1)))
 (let (($x926 (not $x925)))
 ...
 (let (($x1271 (not $x1270)))
 (let (($x1272 (= state_1 stateq0)))
 (let (($x1273 (= par2_1 par2q0)))
 (let (($x1274 (= par1_1 par1q0)))
 (let (($x1275 (= deadline_1 deadlineq0)))
 (let (($x1238 (= oracle_1 oracleq0)))
 (let (($x1279 (and (= awq0_0 aw_1_0) (= awq0_1 aw_1_1) (= awq0_2 aw_1_2))))
 (let (($x1280 (= wq0 t_wq0_0)))
 (let (($x1283 (= t_wq0_0 (+ w_1 xn_q0))))
 (let (($x1285 (= t_stateq0_0 stateq0)))
 (let (($x1289 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x1290 (= wq0 t_wq0_1)))
 (let (($x1291 (and $x1290 $x1289 $x1238 $x1275 $x1274 $x1273 $x1285)))
 (let (($x1304 (and (ite (= par2_1 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_1 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_1 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x1306 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x1310 (and (= wq0 w_1) $x1279 $x1238 $x1275 $x1274 $x1273 $x1272)))
 (let (($x1313 (= t_awq0_0_2 aw_1_2)))
 (let (($x446 (= par1_1 2)))
 (let (($x1316 (= t_awq0_0_1 aw_1_1)))
 (let (($x442 (= par1_1 1)))
 (let (($x1319 (= t_awq0_0_0 aw_1_0)))
 (let (($x438 (= par1_1 0)))
 (let (($x1322 (and (ite $x438 (= t_awq0_0_0 (+ aw_1_0 1)) $x1319) (ite $x442 (= t_awq0_0_1 (+ aw_1_1 1)) $x1316) (ite $x446 (= t_awq0_0_2 (+ aw_1_2 1)) $x1313))))
 (let (($x1325 (and (and (= t_wq0_0 (- w_1 1)) $x1322) (and (ite $x435 $x1310 (and (and $x1306 $x1304) true $x1291)) true $x1291))))
 (let (($x434 (not (>= block_num_1 deadline_1))))
 (let (($x1330 (= t_stateq0_0 2)))
 (let (($x1331 (and $x1330 (ite $x434 $x1310 (and (and (ite $x435 $x1310 $x1325) true $x1291))))))
 (let (($x378 (= state_1 1)))
 (let (($x379 (not $x378)))
 (let (($x1337 (not (= xn_q0 0))))
 (let (($x1339 (= f_q0 timeout)))
 (let (($x1340 (ite $x1339 (ite $x1337 $x1310 (and (ite $x379 $x1310 (and (and $x1331 true $x1291))))) (and $x1283 (and $x1280 $x1279 $x1238 $x1275 $x1274 $x1273 $x1272)))))
 (let (($x1344 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x1345 (and $x1280 $x1344 $x1238 $x1275 $x1274 $x1273 $x1285)))
 (let (($x1355 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_1_0 w_1)) $x1319) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_1_1 w_1)) $x1316) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_1_2 w_1)) $x1313))))
 (let (($x389 (>= w_1 0)))
 (let (($x390 (not $x389)))
 (let (($x1359 (ite $x390 $x1310 (and (and (= t_wq0_0 (- w_1 w_1)) $x1355) true $x1345))))
 (let (($x1366 (ite (not (or (= win_winner0_q par1_1) (= win_winner0_q par2_1))) $x1310 (and (and $x1359 true $x1345)))))
 (let (($x383 (< block_num_1 deadline_1)))
 (let (($x384 (not $x383)))
 (let (($x639 (not (= oracle_1 oracle_1))))
 (let (($x1372 (ite $x639 $x1310 (and (and (ite $x384 $x1310 (and (and $x1366 true $x1345))) true $x1345)))))
 (let (($x1378 (ite $x1337 $x1310 (and (ite $x379 $x1310 (and (and (and $x1330 $x1372) true $x1345)))))))
 (let (($x1379 (= f_q0 win)))
 (let (($x1381 (= t_par2q0_0 par2q0)))
 (let (($x1382 (and $x1280 $x1279 $x1238 $x1275 $x1274 $x1381 $x1285)))
 (let (($x616 (not (and (distinct oracle_1 par1_1) true))))
 (let (($x1387 (and (ite $x616 $x1310 (and (and (= t_par2q0_0 oracle_1) true $x1382))) true $x1382)))
 (let (($x1390 (not (= xn_q0 1))))
 (let (($x1392 (= t_stateq0_0 1)))
 (let (($x340 (= state_1 0)))
 (let (($x341 (not $x340)))
 (let (($x1396 (ite $x341 $x1310 (and (and (and $x1392 (ite $x1390 $x1310 (and $x1387))) true $x1382)))))
 (let (($x1399 (= f_q0 join)))
 (let (($x334 (>= aw_1_2 0)))
 (let (($x333 (>= aw_1_1 0)))
 (let (($x332 (>= aw_1_0 0)))
 ...
 (let (($x1403 (and $x1402 $x335 $x597 (ite $x1399 (and $x1283 (and $x1396)) (ite $x1379 $x1378 $x1340)))))
 (or (not $x1403) $x1271 $x806)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x591 (= w_1 2)))
 (let (($x383 (< block_num_1 deadline_1)))

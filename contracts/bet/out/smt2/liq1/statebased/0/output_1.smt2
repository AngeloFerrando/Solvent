...
(assert
 (let (($x383 (exists ((xa_q Int) )(let (($x381 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (win_winner0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) (deadlineq0 Int) (t_deadlineq0_0 Int) (par1q0 Int) (t_par1q0_0 Int) (par2q0 Int) (t_par2q0_0 Int) (stateq0 Int) (t_stateq0_0 Int) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (win_winner1_q Int) (oracleq1 Int) (t_oracleq1_0 Int) (deadlineq1 Int) (t_deadlineq1_0 Int) (par1q1 Int) (t_par1q1_0 Int) (par2q1 Int) (t_par2q1_0 Int) (stateq1 Int) (t_stateq1_0 Int) )(let (($x462 (and (or (and (distinct par2_1 0) true) (not (>= (- awq1_0 aw_1_0) 2))) (or (and (distinct par2_1 1) true) (not (>= (- awq1_1 aw_1_1) 2))) (or (and (distinct par2_1 2) true) (not (>= (- awq1_2 aw_1_2) 2))))))
 (let (($x466 (and (or (and (distinct par1_1 0) true) (not (>= (- awq1_0 aw_1_0) 2))) (or (and (distinct par1_1 1) true) (not (>= (- awq1_1 aw_1_1) 2))) (or (and (distinct par1_1 2) true) (not (>= (- awq1_2 aw_1_2) 2))))))
 ...
 (let (($x747 (= par2_1 par2q0)))
 (let (($x748 (= par1_1 par1q0)))
 (let (($x749 (= deadline_1 deadlineq0)))
 (let (($x750 (= oracle_1 oracleq0)))
 (let (($x754 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x755 (= wq0 t_wq0_0)))
 (let (($x756 (and $x755 $x754 $x750 $x749 $x748 $x747 $x746)))
 (let (($x769 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_1_0 w_1)) (= t_awq0_0_0 aw_1_0)) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_1_1 w_1)) (= t_awq0_0_1 aw_1_1)) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_1_2 w_1)) (= t_awq0_0_2 aw_1_2)))))
 (let (($x777 (and (= awq0_0 aw_1_0) (= awq0_1 aw_1_1) (= awq0_2 aw_1_2))))
 (let (($x779 (and (= wq0 w_1) $x777 $x750 $x749 $x748 $x747 (= state_1 stateq0))))
 (let (($x241 (>= w_1 0)))
 (let (($x242 (not $x241)))
 (let (($x780 (ite $x242 $x779 (and (and (= t_wq0_0 (- w_1 w_1)) $x769) true $x756))))
 (let (($x787 (ite (not (or (= win_winner0_q par1_1) (= win_winner0_q par2_1))) $x779 (and (and $x780 true $x756)))))
 (let (($x788 (= t_stateq0_0 2)))
 (let (($x234 (= state_1 1)))
 (let (($x235 (not $x234)))
 (let (($x795 (not (= xn_q0 0))))
 (let (($x796 (ite $x795 $x779 (and (ite $x235 $x779 (and (and (and $x788 $x787) true $x756)))))))
 (let (($x797 (= t_par2q0_0 par2q0)))
 (let (($x798 (and $x755 $x777 $x750 $x749 $x748 $x797 $x746)))
 (let (($x366 (ite (not (and (distinct xa_q par1_1) true)) $x779 (and (and (= t_par2q0_0 xa_q) true $x798)))))
 (let (($x806 (not (= xn_q0 2))))
 (let (($x808 (= t_stateq0_0 1)))
 (let (($x371 (and (and $x808 (ite $x806 $x779 (and (and $x366 true $x798)))) true $x798)))
 (let (($x197 (= state_1 0)))
 (let (($x198 (not $x197)))
 (let (($x817 (= f_q0 join)))
 (let (($x376 (ite $x817 (and (= t_wq0_0 (+ w_1 xn_q0)) (and (ite $x198 $x779 (and $x371)))) $x796)))
 (let (($x191 (>= aw_1_2 0)))
 (let (($x190 (>= aw_1_1 0)))
 (let (($x189 (>= aw_1_0 0)))
 (let (($x192 (and $x189 $x190 $x191)))
 (let (($x377 (and $x357 $x540 (>= xn_q0 0))))
 (or (not (and $x377 $x192 $x326 $x376)) (not (and $x358 $x742 $x326 $x538)) $x467)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x234 (= state_1 1)))
 (let (($x352 (<= xa_q 2)))
 (let (($x353 (>= xa_q 0)))

...
(assert
 ...
 (let (($x1198 (and (and $x866 (ite (not (>= block_num_1 deadlineq3)) $x1168 $x1193)) true $x1157)))
 ...
 (let (($x1240 (ite (not (= oracle_1 oracleq3)) $x1168 (and (and (ite (not (< block_num_1 deadlineq3)) $x1168 $x1232) true $x1206)))))
 ...
 (let (($x1253 (ite (not (and (distinct oracle_1 par1q3) true)) $x1168 (and (and (= t_par2q4_0 oracle_1) true $x1248)))))
 (let (($x925 (= xn_q4 1)))
 (let (($x926 (not $x925)))
 ...
 (let (($x1660 (and (and $x1330 (ite (not (>= block_num_1 deadlineq2)) $x1630 $x1655)) true $x1619)))
 ...
 (let (($x1702 (ite (not (= oracle_1 oracleq2)) $x1630 (and (and (ite (not (< block_num_1 deadlineq2)) $x1630 $x1694) true $x1668)))))
 ...
 (let (($x1715 (ite (not (and (distinct oracle_1 par1q2) true)) $x1630 (and (and (= t_par2q3_0 oracle_1) true $x1710)))))
 ...
 (let (($x2122 (and (and $x1792 (ite (not (>= block_num_1 deadlineq1)) $x2092 $x2117)) true $x2081)))
 (let (($x2124 (= stateq1 1)))
 (let (($x2125 (not $x2124)))
 (let (($x1798 (= xn_q2 0)))
 (let (($x1799 (not $x1798)))
 ...
 (let (($x2164 (ite (not (= oracle_1 oracleq1)) $x2092 (and (and (ite (not (< block_num_1 deadlineq1)) $x2092 $x2156) true $x2130)))))
 ...
 (let (($x2177 (ite (not (and (distinct oracle_1 par1q1) true)) $x2092 (and (and (= t_par2q2_0 oracle_1) true $x2172)))))
 (let (($x1851 (= xn_q2 1)))
 (let (($x1852 (not $x1851)))
 ...
 (let (($x2584 (and (and $x2254 (ite (not (>= block_num_1 deadlineq0)) $x2554 $x2579)) true $x2543)))
 ...
 (let (($x2626 (ite (not (= oracle_1 oracleq0)) $x2554 (and (and (ite (not (< block_num_1 deadlineq0)) $x2554 $x2618) true $x2592)))))
 (let (($x2632 (ite $x2261 $x2554 (and (ite $x2587 $x2554 (and (and (and $x2254 $x2626) true $x2592)))))))
 (let (($x2303 (= f_q1 win)))
 (let (($x2633 (ite $x2303 $x2632 (ite $x2263 (ite $x2261 $x2554 (and (ite $x2587 $x2554 (and $x2584)))) $x2542))))
 (let (($x2305 (= t_par2q1_0 par2q1)))
 (let (($x2634 (and $x2204 $x2538 $x2534 $x2533 $x2532 $x2305 $x2209)))
 (let (($x2639 (ite (not (and (distinct oracle_1 par1q0) true)) $x2554 (and (and (= t_par2q1_0 oracle_1) true $x2634)))))
 (let (($x2314 (not (= xn_q1 1))))
 (let (($x2316 (= t_stateq1_0 1)))
 (let (($x2644 (and (and $x2316 (ite $x2314 $x2554 (and (and $x2639 true $x2634)))) true $x2634)))
 (let (($x2647 (not (= stateq0 0))))
 (let (($x2323 (= f_q1 join)))
 (let (($x2655 (and (>= awq0_0 0) (>= awq0_1 0) (>= awq0_2 0))))
 (let (($x2325 (>= xn_q1 0)))
 (let (($x2326 (and $x593 $x594 $x2325)))
 (let (($x2656 (and $x2326 $x2655 $x597 (ite $x2323 (and $x2541 (and (ite $x2647 $x2554 (and $x2644)))) $x2633))))
 (let (($x2658 (= state_1 stateq0)))
 (let (($x2659 (= par2_1 par2q0)))
 (let (($x2660 (= par1_1 par1q0)))
 (let (($x2661 (= deadline_1 deadlineq0)))
 (let (($x2624 (= oracle_1 oracleq0)))
 (let (($x2665 (and (= awq0_0 aw_1_0) (= awq0_1 aw_1_1) (= awq0_2 aw_1_2))))
 (let (($x2666 (= wq0 t_wq0_0)))
 (let (($x2669 (= t_wq0_0 (+ w_1 xn_q0))))
 (let (($x2671 (= t_stateq0_0 stateq0)))
 (let (($x2675 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x2676 (= wq0 t_wq0_1)))
 (let (($x2677 (and $x2676 $x2675 $x2624 $x2661 $x2660 $x2659 $x2671)))
 (let (($x2690 (and (ite (= par2_1 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_1 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_1 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x2692 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x2696 (and (= wq0 w_1) $x2665 $x2624 $x2661 $x2660 $x2659 $x2658)))
 (let (($x2699 (= t_awq0_0_2 aw_1_2)))
 (let (($x446 (= par1_1 2)))
 (let (($x2702 (= t_awq0_0_1 aw_1_1)))
 (let (($x442 (= par1_1 1)))
 (let (($x2705 (= t_awq0_0_0 aw_1_0)))
 (let (($x438 (= par1_1 0)))
 (let (($x2708 (and (ite $x438 (= t_awq0_0_0 (+ aw_1_0 1)) $x2705) (ite $x442 (= t_awq0_0_1 (+ aw_1_1 1)) $x2702) (ite $x446 (= t_awq0_0_2 (+ aw_1_2 1)) $x2699))))
 (let (($x2711 (and (and (= t_wq0_0 (- w_1 1)) $x2708) (and (ite $x435 $x2696 (and (and $x2692 $x2690) true $x2677)) true $x2677))))
 (let (($x434 (not (>= block_num_1 deadline_1))))
 (let (($x2716 (= t_stateq0_0 2)))
 (let (($x2717 (and $x2716 (ite $x434 $x2696 (and (and (ite $x435 $x2696 $x2711) true $x2677))))))
 (let (($x378 (= state_1 1)))
 (let (($x379 (not $x378)))
 (let (($x2723 (not (= xn_q0 0))))
 (let (($x2725 (= f_q0 timeout)))
 (let (($x2726 (ite $x2725 (ite $x2723 $x2696 (and (ite $x379 $x2696 (and (and $x2717 true $x2677))))) (and $x2669 (and $x2666 $x2665 $x2624 $x2661 $x2660 $x2659 $x2658)))))
 (let (($x2730 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x2731 (and $x2666 $x2730 $x2624 $x2661 $x2660 $x2659 $x2671)))
 (let (($x2741 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_1_0 w_1)) $x2705) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_1_1 w_1)) $x2702) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_1_2 w_1)) $x2699))))
 (let (($x389 (>= w_1 0)))
 (let (($x390 (not $x389)))
 (let (($x2745 (ite $x390 $x2696 (and (and (= t_wq0_0 (- w_1 w_1)) $x2741) true $x2731))))
 (let (($x2752 (ite (not (or (= win_winner0_q par1_1) (= win_winner0_q par2_1))) $x2696 (and (and $x2745 true $x2731)))))
 (let (($x383 (< block_num_1 deadline_1)))
 (let (($x384 (not $x383)))
 (let (($x639 (not (= oracle_1 oracle_1))))
 (let (($x2758 (ite $x639 $x2696 (and (and (ite $x384 $x2696 (and (and $x2752 true $x2731))) true $x2731)))))
 (let (($x2764 (ite $x2723 $x2696 (and (ite $x379 $x2696 (and (and (and $x2716 $x2758) true $x2731)))))))
 (let (($x2765 (= f_q0 win)))
 (let (($x2767 (= t_par2q0_0 par2q0)))
 (let (($x2768 (and $x2666 $x2665 $x2624 $x2661 $x2660 $x2767 $x2671)))
 (let (($x616 (not (and (distinct oracle_1 par1_1) true))))
 (let (($x2773 (and (ite $x616 $x2696 (and (and (= t_par2q0_0 oracle_1) true $x2768))) true $x2768)))
 (let (($x2776 (not (= xn_q0 1))))
 (let (($x2778 (= t_stateq0_0 1)))
 (let (($x340 (= state_1 0)))
 (let (($x341 (not $x340)))
 (let (($x2782 (ite $x341 $x2696 (and (and (and $x2778 (ite $x2776 $x2696 (and $x2773))) true $x2768)))))
 (let (($x2785 (= f_q0 join)))
 (let (($x334 (>= aw_1_2 0)))
 (let (($x333 (>= aw_1_1 0)))
 (let (($x332 (>= aw_1_0 0)))
 (let (($x335 (and $x332 $x333 $x334)))
 (let (($x2789 (and (and $x593 $x594 (>= xn_q0 0)) $x335 $x597 (ite $x2785 (and $x2669 (and $x2782)) (ite $x2765 $x2764 $x2726)))))
 (or (not $x2789) (not $x2656) $x2195 $x1733 $x1271 $x806)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x591 (= w_1 2)))
 (let (($x383 (< block_num_1 deadline_1)))

...
(assert
 (let (($x1063 (exists ((xa_q Int) )(let (($x542 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (bq0 Bool) (t_bq0_0 Bool) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (block_num_q1 Int) (pay_amount1_q Int) (bq1 Bool) (t_bq1_0 Bool) )(let (($x602 (and (or (and (distinct xa_q 0) true) (not (= awq1_0 (+ aw_1_0 w_1)))) (or (and (distinct xa_q 1) true) (not (= awq1_1 (+ aw_1_1 w_1)))) (or (and (distinct xa_q 2) true) (not (= awq1_2 (+ aw_1_2 w_1)))))))
 ...
 (let (($x524 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_1_0 pay_amount0_q)) (= t_awq0_0_0 aw_1_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_1_1 pay_amount0_q)) (= t_awq0_0_1 aw_1_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_1_2 pay_amount0_q)) (= t_awq0_0_2 aw_1_2)))))
 (let (($x816 (= b_1 bq0)))
 (let (($x817 (= awq0_2 aw_1_2)))
 (let (($x818 (= awq0_1 aw_1_1)))
 (let (($x819 (= awq0_0 aw_1_0)))
 (let (($x820 (and $x819 $x818 $x817)))
 (let (($x821 (= wq0 w_1)))
 (let (($x822 (and $x821 $x820 $x816)))
 (let (($x823 (>= pay_amount0_q 0)))
 (let (($x824 (not $x823)))
 (let (($x826 (= t_bq0_0 false)))
 (let (($x529 (and $x826 (ite $x824 $x822 (and (and (= t_wq0_0 (- w_1 pay_amount0_q)) $x524) true $x798)))))
 (let (($x532 (ite (not (and (<= pay_amount0_q w_1) b_1)) $x822 (and (and $x529 true $x798)))))
 (let (($x835 (= xn_q0 0)))
 (let (($x836 (not $x835)))
 (let (($x180 (not b_1)))
 (let (($x181 (not $x180)))
 (let (($x842 (ite $x181 $x822 (and (and (= t_bq0_0 true) true (and $x821 $x820 $x792))))))
 ...
 (let (($x537 (and $x536 $x168 (>= block_num_q0 block_num_1) (ite $x845 (ite $x836 $x822 (and $x842)) (ite $x836 $x822 (and $x532))))))
 (or (not $x537) $x519 $x602))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x937 (= b_1 true)))
 (let (($x511 (<= xa_q 2)))
 (let (($x512 (>= xa_q 0)))

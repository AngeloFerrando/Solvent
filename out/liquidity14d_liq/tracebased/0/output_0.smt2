...
(assert
 (let (($x1071 (exists ((xa_q Int) )(let (($x510 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (bq0 Bool) (t_bq0_0 Bool) )(let (($x484 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_1_0 w_1)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_1_1 w_1)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_1_2 w_1)))))))
 (let (($x579 (= t_bq0_0 bq0)))
 (let (($x584 (= wq0 t_wq0_0)))
 (let (($x585 (and $x584 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2)) $x579)))
 (let (($x491 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_1_0 pay_amount0_q)) (= t_awq0_0_0 aw_1_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_1_1 pay_amount0_q)) (= t_awq0_0_1 aw_1_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_1_2 pay_amount0_q)) (= t_awq0_0_2 aw_1_2)))))
 (let (($x603 (= b_1 bq0)))
 (let (($x604 (= awq0_2 aw_1_2)))
 (let (($x605 (= awq0_1 aw_1_1)))
 (let (($x606 (= awq0_0 aw_1_0)))
 (let (($x607 (and $x606 $x605 $x604)))
 (let (($x608 (= wq0 w_1)))
 (let (($x609 (and $x608 $x607 $x603)))
 (let (($x610 (>= pay_amount0_q 0)))
 (let (($x611 (not $x610)))
 (let (($x613 (= t_bq0_0 false)))
 (let (($x495 (and $x613 (ite $x611 $x609 (and (and (= t_wq0_0 (- w_1 pay_amount0_q)) $x491) true $x585)))))
 (let (($x498 (ite (not (and (<= pay_amount0_q w_1) b_1)) $x609 (and (and $x495 true $x585)))))
 (let (($x622 (= xn_q0 0)))
 (let (($x623 (not $x622)))
 (let (($x180 (not b_1)))
 (let (($x181 (not $x180)))
 (let (($x629 (ite $x181 $x609 (and (and (= t_bq0_0 true) true (and $x608 $x607 $x579))))))
 ...
 (let (($x506 (and $x505 $x168 (>= block_num_q0 block_num_1) (ite $x632 (ite $x623 $x609 (and $x629)) (ite $x623 $x609 (and $x498))))))
 (or (not $x506) $x484))))))))))))))))))))))))))))))))))
 ))
 (let (($x937 (= b_1 true)))
 (let (($x511 (<= xa_q 2)))

...
(assert
 (let (($x517 (exists ((xa_q Int) )(let (($x511 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (bq0 Bool) (t_bq0_0 Bool) )(let (($x485 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_1_0 w_1)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_1_1 w_1)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_1_2 w_1)))))))
 (let (($x580 (= t_bq0_0 bq0)))
 (let (($x585 (= wq0 t_wq0_0)))
 (let (($x586 (and $x585 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2)) $x580)))
 (let (($x492 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_1_0 pay_amount0_q)) (= t_awq0_0_0 aw_1_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_1_1 pay_amount0_q)) (= t_awq0_0_1 aw_1_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_1_2 pay_amount0_q)) (= t_awq0_0_2 aw_1_2)))))
 (let (($x604 (= b_1 bq0)))
 (let (($x605 (= awq0_2 aw_1_2)))
 (let (($x606 (= awq0_1 aw_1_1)))
 (let (($x607 (= awq0_0 aw_1_0)))
 (let (($x608 (and $x607 $x606 $x605)))
 (let (($x609 (= wq0 w_1)))
 (let (($x610 (and $x609 $x608 $x604)))
 (let (($x611 (>= pay_amount0_q 0)))
 (let (($x612 (not $x611)))
 (let (($x614 (= t_bq0_0 false)))
 (let (($x496 (and $x614 (ite $x612 $x610 (and (and (= t_wq0_0 (- w_1 pay_amount0_q)) $x492) true $x586)))))
 (let (($x499 (ite (not (and (<= pay_amount0_q w_1) b_1)) $x610 (and (and $x496 true $x586)))))
 (let (($x623 (= xn_q0 0)))
 (let (($x624 (not $x623)))
 (let (($x180 (not b_1)))
 (let (($x181 (not $x180)))
 (let (($x630 (ite $x181 $x610 (and (and (= t_bq0_0 true) true (and $x609 $x608 $x580))))))
 ...
 (let (($x507 (and $x506 $x168 (>= block_num_q0 block_num_1) (ite $x633 (ite $x624 $x610 (and $x630)) (ite $x624 $x610 (and $x499))))))
 (or (not $x507) $x485))))))))))))))))))))))))))))))))))
 ))
 (let (($x475 (= b_1 true)))
 (let (($x512 (<= xa_q 2)))

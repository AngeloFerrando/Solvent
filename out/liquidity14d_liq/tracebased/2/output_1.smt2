...
(assert
 (let (($x1013 (exists ((xa_q Int) )(let (($x657 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (bq0 Bool) (t_bq0_0 Bool) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (block_num_q1 Int) (pay_amount1_q Int) (bq1 Bool) (t_bq1_0 Bool) )(let (($x929 (and (or (and (distinct xa_q 0) true) (not (= awq1_0 (+ aw_3_0 w_3)))) (or (and (distinct xa_q 1) true) (not (= awq1_1 (+ aw_3_1 w_3)))) (or (and (distinct xa_q 2) true) (not (= awq1_2 (+ aw_3_2 w_3)))))))
 ...
 (let (($x873 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_3_0 pay_amount0_q)) (= t_awq0_0_0 aw_3_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_3_1 pay_amount0_q)) (= t_awq0_0_1 aw_3_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_3_2 pay_amount0_q)) (= t_awq0_0_2 aw_3_2)))))
 (let (($x1081 (= b_3 bq0)))
 (let (($x1082 (= awq0_2 aw_3_2)))
 (let (($x1083 (= awq0_1 aw_3_1)))
 (let (($x1084 (= awq0_0 aw_3_0)))
 (let (($x1085 (and $x1084 $x1083 $x1082)))
 (let (($x1086 (= wq0 w_3)))
 (let (($x1087 (and $x1086 $x1085 $x1081)))
 (let (($x823 (>= pay_amount0_q 0)))
 (let (($x824 (not $x823)))
 (let (($x826 (= t_bq0_0 false)))
 (let (($x884 (and $x826 (ite $x824 $x1087 (and (and (= t_wq0_0 (- w_3 pay_amount0_q)) $x873) true $x798)))))
 (let (($x890 (ite (not (and (<= pay_amount0_q w_3) b_3)) $x1087 (and (and $x884 true $x798)))))
 (let (($x835 (= xn_q0 0)))
 (let (($x836 (not $x835)))
 (let (($x388 (not b_3)))
 (let (($x389 (not $x388)))
 (let (($x1101 (ite $x389 $x1087 (and (and (= t_bq0_0 true) true (and $x1086 $x1085 $x792))))))
 ...
 (let (($x853 (and $x536 $x376 (>= block_num_q0 block_num_3) (ite $x845 (ite $x836 $x1087 (and $x1101)) (ite $x836 $x1087 (and $x890))))))
 (or (not $x853) $x519 $x929))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x1096 (= b_3 true)))
 (let (($x511 (<= xa_q 2)))
 (let (($x512 (>= xa_q 0)))

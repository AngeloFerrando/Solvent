...
(assert
 (let (($x1016 (exists ((xa_q Int) )(let (($x932 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (bq0 Bool) (t_bq0_0 Bool) )(let (($x739 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_3_0 w_3)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_3_1 w_3)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_3_2 w_3)))))))
 (let (($x579 (= t_bq0_0 bq0)))
 (let (($x584 (= wq0 t_wq0_0)))
 (let (($x585 (and $x584 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2)) $x579)))
 (let (($x965 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_3_0 pay_amount0_q)) (= t_awq0_0_0 aw_3_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_3_1 pay_amount0_q)) (= t_awq0_0_1 aw_3_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_3_2 pay_amount0_q)) (= t_awq0_0_2 aw_3_2)))))
 (let (($x874 (= b_3 bq0)))
 (let (($x875 (= awq0_2 aw_3_2)))
 (let (($x876 (= awq0_1 aw_3_1)))
 (let (($x877 (= awq0_0 aw_3_0)))
 (let (($x878 (and $x877 $x876 $x875)))
 (let (($x879 (= wq0 w_3)))
 (let (($x880 (and $x879 $x878 $x874)))
 (let (($x610 (>= pay_amount0_q 0)))
 (let (($x611 (not $x610)))
 (let (($x613 (= t_bq0_0 false)))
 (let (($x976 (and $x613 (ite $x611 $x880 (and (and (= t_wq0_0 (- w_3 pay_amount0_q)) $x965) true $x585)))))
 (let (($x982 (ite (not (and (<= pay_amount0_q w_3) b_3)) $x880 (and (and $x976 true $x585)))))
 (let (($x622 (= xn_q0 0)))
 (let (($x623 (not $x622)))
 (let (($x388 (not b_3)))
 (let (($x389 (not $x388)))
 (let (($x894 (ite $x389 $x880 (and (and (= t_bq0_0 true) true (and $x879 $x878 $x579))))))
 ...
 (let (($x946 (and $x505 $x376 (>= block_num_q0 block_num_3) (ite $x632 (ite $x623 $x880 (and $x894)) (ite $x623 $x880 (and $x982))))))
 (or (not $x946) $x739))))))))))))))))))))))))))))))))))
 ))
 (let (($x1096 (= b_3 true)))
 (let (($x511 (<= xa_q 2)))

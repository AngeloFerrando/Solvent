...
(assert
 (let (($x692 (exists ((xa_q Int) )(let (($x702 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) )(let (($x733 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_3_0 w_3)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_3_1 w_3)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_3_2 w_3)))))))
 (let (($x610 (= wq0 t_wq0_0)))
 (let (($x611 (and $x610 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2)))))
 (let (($x718 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_3_0 pay_amount0_q)) (= t_awq0_0_0 aw_3_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_3_1 pay_amount0_q)) (= t_awq0_0_1 aw_3_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_3_2 pay_amount0_q)) (= t_awq0_0_2 aw_3_2)))))
 (let (($x794 (= wq0 w_3)))
 (let (($x795 (and $x794 (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2)))))
 (let (($x635 (>= pay_amount0_q 0)))
 (let (($x636 (not $x635)))
 (let (($x737 (and (ite $x636 $x795 (and (and (= t_wq0_0 (- w_3 pay_amount0_q)) $x718) true)))))
 (let (($x773 (= t_awq0_0_2 aw_3_2)))
 (let (($x513 (= xa_q 2)))
 (let (($x777 (= t_awq0_0_1 aw_3_1)))
 (let (($x502 (= xa_q 1)))
 (let (($x781 (= t_awq0_0_0 aw_3_0)))
 (let (($x504 (= xa_q 0)))
 (let (($x726 (and (ite $x504 (= t_awq0_0_0 (+ aw_3_0 (- pay_amount0_q 1))) $x781) (ite $x502 (= t_awq0_0_1 (+ aw_3_1 (- pay_amount0_q 1))) $x777) (ite $x513 (= t_awq0_0_2 (+ aw_3_2 (- pay_amount0_q 1))) $x773))))
 (let (($x655 (not (>= (- pay_amount0_q 1) 0))))
 (let (($x745 (ite $x655 $x795 (and (and (= t_wq0_0 (- w_3 (- pay_amount0_q 1))) $x726) true))))
 (let (($x528 (and $x504)))
 (let (($x755 (ite (not (<= pay_amount0_q w_3)) $x795 (and (and (ite $x528 (and $x745) $x737) true $x611)))))
 (let (($x665 (= xn_q0 0)))
 (let (($x666 (not $x665)))
 (let (($x378 (>= aw_3_2 0)))
 (let (($x377 (>= aw_3_1 0)))
 ...
 (let (($x685 (not (and $x537 $x379 (>= block_num_q0 block_num_3) (ite $x666 $x795 (and $x755))))))
 (or $x685 $x733)))))))))))))))))))))))))))))))
 ))
 (let (($x542 (<= xa_q 2)))
 (let (($x635 (>= xa_q 0)))

...
(assert
 ...
 (let (($x647 (not $x646)))
 (let (($x1865 (= oracle_3 oracleq0)))
 (let (($x1321 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x1322 (= wq0 t_wq0_0)))
 (let (($x1866 (and $x1322 $x1321 $x1865)))
 (let (($x1788 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_3_0 pay_amount0_q)) (= t_awq0_0_0 aw_3_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_3_1 pay_amount0_q)) (= t_awq0_0_1 aw_3_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_3_2 pay_amount0_q)) (= t_awq0_0_2 aw_3_2)))))
 (let (($x1889 (and (= wq0 w_3) (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2)) $x1865)))
 (let (($x1348 (not (>= pay_amount0_q 0))))
 (let (($x1771 (and (ite $x1348 $x1889 (and (and (= t_wq0_0 (- w_3 pay_amount0_q)) $x1788) true $x1866)) true $x1866)))
 ...
 (let (($x1750 (and $x768 $x374 (>= block_num_q0 block_num_3) (ite $x1357 $x1889 (and (ite (not (<= pay_amount0_q w_3)) $x1889 (and $x1771)))))))
 (or (not $x1750) $x647 $x1030 $x1060 $x1101 $x1366)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

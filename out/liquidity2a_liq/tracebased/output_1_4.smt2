...
(assert
 ...
 (let (($x647 (not $x646)))
 (let (($x1631 (= oracle_2 oracleq0)))
 (let (($x1321 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x1322 (= wq0 t_wq0_0)))
 (let (($x1632 (and $x1322 $x1321 $x1631)))
 (let (($x1554 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_2_0 pay_amount0_q)) (= t_awq0_0_0 aw_2_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_2_1 pay_amount0_q)) (= t_awq0_0_1 aw_2_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_2_2 pay_amount0_q)) (= t_awq0_0_2 aw_2_2)))))
 (let (($x1655 (and (= wq0 w_2) (and (= awq0_0 aw_2_0) (= awq0_1 aw_2_1) (= awq0_2 aw_2_2)) $x1631)))
 (let (($x1348 (not (>= pay_amount0_q 0))))
 (let (($x1537 (and (ite $x1348 $x1655 (and (and (= t_wq0_0 (- w_2 pay_amount0_q)) $x1554) true $x1632)) true $x1632)))
 ...
 (let (($x1516 (and $x768 $x291 (>= block_num_q0 block_num_2) (ite $x1357 $x1655 (and (ite (not (<= pay_amount0_q w_2)) $x1655 (and $x1537)))))))
 (or (not $x1516) $x647 $x1030 $x1060 $x1101 $x1402)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

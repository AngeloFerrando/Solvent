...
(assert
 (let (($x593 (exists ((xa_q Int) )(let (($x521 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (block_num_q1 Int) (pay_amount1_q Int) (oracleq1 Int) (t_oracleq1_0 Int) )(let (($x589 (and (or (and (distinct xa_q 0) true) (not (= awq1_0 (+ aw_1_0 w_1)))) (or (and (distinct xa_q 1) true) (not (= awq1_1 (+ aw_1_1 w_1)))) (or (and (distinct xa_q 2) true) (not (= awq1_2 (+ aw_1_2 w_1)))))))
 ...
 (let (($x497 (not $x496)))
 (let (($x717 (= oracle_1 oracleq0)))
 (let (($x718 (= awq0_2 t_awq0_0_2)))
 (let (($x721 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) $x718)))
 (let (($x722 (= wq0 t_wq0_0)))
 (let (($x723 (and $x722 $x721 $x717)))
 (let (($x501 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_1_0 pay_amount0_q)) (= t_awq0_0_0 aw_1_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_1_1 pay_amount0_q)) (= t_awq0_0_1 aw_1_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_1_2 pay_amount0_q)) (= t_awq0_0_2 aw_1_2)))))
 (let (($x746 (and (= wq0 w_1) (and (= awq0_0 aw_1_0) (= awq0_1 aw_1_1) (= awq0_2 aw_1_2)) $x717)))
 (let (($x748 (not (>= pay_amount0_q 0))))
 (let (($x507 (and (ite $x748 $x746 (and (and (= t_wq0_0 (- w_1 pay_amount0_q)) $x501) true $x723)) true $x723)))
 ...
 (let (($x517 (and $x516 $x206 (>= block_num_q0 block_num_1) (ite $x757 $x746 (and (ite (not (<= pay_amount0_q w_1)) $x746 (and $x507)))))))
 (or (not $x517) $x497 $x589))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

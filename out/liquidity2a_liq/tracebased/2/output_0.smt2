...
(assert
 (let (($x602 (exists ((xa_q Int) )(let (($x547 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) )(let (($x438 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_3_0 w_3)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_3_1 w_3)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_3_2 w_3)))))))
 (let (($x619 (= oracle_3 oracleq0)))
 ...
 (let (($x620 (and $x493 $x492 $x619)))
 (let (($x600 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_3_0 pay_amount0_q)) (= t_awq0_0_0 aw_3_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_3_1 pay_amount0_q)) (= t_awq0_0_1 aw_3_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_3_2 pay_amount0_q)) (= t_awq0_0_2 aw_3_2)))))
 (let (($x643 (and (= wq0 w_3) (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2)) $x619)))
 (let (($x519 (not (>= pay_amount0_q 0))))
 (let (($x583 (and (ite $x519 $x643 (and (and (= t_wq0_0 (- w_3 pay_amount0_q)) $x600) true $x620)) true $x620)))
 ...
 (let (($x537 (and $x427 $x318 (>= block_num_q0 block_num_3) (ite $x528 $x643 (and (ite (not (<= pay_amount0_q w_3)) $x643 (and $x583)))))))
 (or (not $x537) $x438)))))))))))))))))))))
 ))
 (let (($x432 (<= xa_q 2)))
 (let (($x433 (>= xa_q 0)))

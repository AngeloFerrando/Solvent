...
(assert
 ...
 (let (($x598 (not $x597)))
 (let (($x902 (= oracle_1 oracleq0)))
 (let (($x906 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x907 (= wq0 t_wq0_0)))
 (let (($x908 (and $x907 $x906 $x902)))
 (let (($x609 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_1_0 pay_amount0_q)) (= t_awq0_0_0 aw_1_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_1_1 pay_amount0_q)) (= t_awq0_0_1 aw_1_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_1_2 pay_amount0_q)) (= t_awq0_0_2 aw_1_2)))))
 (let (($x931 (and (= wq0 w_1) (and (= awq0_0 aw_1_0) (= awq0_1 aw_1_1) (= awq0_2 aw_1_2)) $x902)))
 (let (($x933 (not (>= pay_amount0_q 0))))
 (let (($x602 (and (ite $x933 $x931 (and (and (= t_wq0_0 (- w_1 pay_amount0_q)) $x609) true $x908)) true $x908)))
 ...
 (let (($x619 (and $x618 $x206 (>= block_num_q0 block_num_1) (ite $x942 $x931 (and (ite (not (<= pay_amount0_q w_1)) $x931 (and $x602)))))))
 (or (not $x619) $x598 $x716 $x762)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

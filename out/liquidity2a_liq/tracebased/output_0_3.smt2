...
(assert
 ...
 (let (($x629 (not $x628)))
 (let (($x1102 (= oracle_1 oracleq0)))
 (let (($x1106 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x1107 (= wq0 t_wq0_0)))
 (let (($x1108 (and $x1107 $x1106 $x1102)))
 (let (($x622 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_1_0 pay_amount0_q)) (= t_awq0_0_0 aw_1_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_1_1 pay_amount0_q)) (= t_awq0_0_1 aw_1_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_1_2 pay_amount0_q)) (= t_awq0_0_2 aw_1_2)))))
 (let (($x1131 (and (= wq0 w_1) (and (= awq0_0 aw_1_0) (= awq0_1 aw_1_1) (= awq0_2 aw_1_2)) $x1102)))
 (let (($x1132 (>= pay_amount0_q 0)))
 (let (($x1133 (not $x1132)))
 (let (($x626 (and (ite $x1133 $x1131 (and (and (= t_wq0_0 (- w_1 pay_amount0_q)) $x622) true $x1108)) true $x1108)))
 ...
 (let (($x636 (and $x635 $x206 (>= block_num_q0 block_num_1) (ite $x1142 $x1131 (and (ite (not (<= pay_amount0_q w_1)) $x1131 (and $x626)))))))
 (or (not $x636) $x629 $x860 $x901 $x947)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

...
(assert
 ...
 (let (($x598 (not $x597)))
 (let (($x1370 (= oracle_3 oracleq0)))
 (let (($x906 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x907 (= wq0 t_wq0_0)))
 (let (($x1445 (and $x907 $x906 $x1370)))
 (let (($x823 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_3_0 pay_amount0_q)) (= t_awq0_0_0 aw_3_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_3_1 pay_amount0_q)) (= t_awq0_0_1 aw_3_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_3_2 pay_amount0_q)) (= t_awq0_0_2 aw_3_2)))))
 (let (($x1565 (and (= wq0 w_3) (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2)) $x1370)))
 (let (($x933 (not (>= pay_amount0_q 0))))
 (let (($x1255 (and (ite $x933 $x1565 (and (and (= t_wq0_0 (- w_3 pay_amount0_q)) $x823) true $x1445)) true $x1445)))
 ...
 (let (($x1273 (and $x618 $x374 (>= block_num_q0 block_num_3) (ite $x942 $x1565 (and (ite (not (<= pay_amount0_q w_3)) $x1565 (and $x1255)))))))
 (or (not $x1273) $x598 $x716 $x1624)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

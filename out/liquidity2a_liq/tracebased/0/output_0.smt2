...
(assert
 (let (($x436 (exists ((xa_q Int) )(let (($x431 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) )(let (($x402 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_1_0 w_1)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_1_1 w_1)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_1_2 w_1)))))))
 (let (($x488 (= oracle_1 oracleq0)))
 ...
 (let (($x494 (and $x493 $x492 $x488)))
 (let (($x413 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_1_0 pay_amount0_q)) (= t_awq0_0_0 aw_1_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_1_1 pay_amount0_q)) (= t_awq0_0_1 aw_1_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_1_2 pay_amount0_q)) (= t_awq0_0_2 aw_1_2)))))
 (let (($x517 (and (= wq0 w_1) (and (= awq0_0 aw_1_0) (= awq0_1 aw_1_1) (= awq0_2 aw_1_2)) $x488)))
 (let (($x519 (not (>= pay_amount0_q 0))))
 (let (($x418 (and (ite $x519 $x517 (and (and (= t_wq0_0 (- w_1 pay_amount0_q)) $x413) true $x494)) true $x494)))
 ...
 (let (($x428 (and $x427 $x150 (>= block_num_q0 block_num_1) (ite $x528 $x517 (and (ite (not (<= pay_amount0_q w_1)) $x517 (and $x418)))))))
 (or (not $x428) $x402)))))))))))))))))))))
 ))
 (let (($x432 (<= xa_q 2)))
 (let (($x433 (>= xa_q 0)))

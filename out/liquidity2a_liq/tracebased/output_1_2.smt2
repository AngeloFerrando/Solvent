...
(assert
 (let (($x993 (exists ((xa_q Int) )(let (($x990 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (block_num_q1 Int) (pay_amount1_q Int) (oracleq1 Int) (t_oracleq1_0 Int) (xn_q2 Int) (f_q2 Proc) (wq2 Int) (awq2_0 Int) (awq2_1 Int) (awq2_2 Int) (t_wq2_0 Int) (t_awq2_0_0 Int) (t_awq2_0_1 Int) (t_awq2_0_2 Int) (block_num_q2 Int) (pay_amount2_q Int) (oracleq2 Int) (t_oracleq2_0 Int) )(let (($x1303 (and (or (and (distinct xa_q 0) true) (not (= awq2_0 (+ aw_2_0 w_2)))) (or (and (distinct xa_q 1) true) (not (= awq2_1 (+ aw_2_1 w_2)))) (or (and (distinct xa_q 2) true) (not (= awq2_2 (+ aw_2_2 w_2)))))))
 (let (($x676 (= oracleq1 oracleq2)))
 (let (($x545 (= awq2_2 t_awq2_0_2)))
 (let (($x546 (= awq2_1 t_awq2_0_1)))
 (let (($x547 (= awq2_0 t_awq2_0_0)))
 (let (($x548 (and $x547 $x546 $x545)))
 (let (($x549 (= wq2 t_wq2_0)))
 (let (($x677 (and $x549 $x548 $x676)))
 (let (($x751 (and (ite (= xa_q 0) (= t_awq2_0_0 (+ awq1_0 pay_amount2_q)) (= t_awq2_0_0 awq1_0)) (ite (= xa_q 1) (= t_awq2_0_1 (+ awq1_1 pay_amount2_q)) (= t_awq2_0_1 awq1_1)) (ite (= xa_q 2) (= t_awq2_0_2 (+ awq1_2 pay_amount2_q)) (= t_awq2_0_2 awq1_2)))))
 (let (($x692 (= t_wq2_0 (- wq1 pay_amount2_q))))
 (let (($x700 (and (= wq2 wq1) (and (= awq2_0 awq1_0) (= awq2_1 awq1_1) (= awq2_2 awq1_2)) $x676)))
 (let (($x575 (not (>= pay_amount2_q 0))))
 (let (($x690 (and (and (ite $x575 $x700 (and (and $x692 $x751) true $x677)) true $x677))))
 (let (($x705 (not (<= pay_amount2_q wq1))))
 (let (($x584 (not (= xn_q2 0))))
 (let (($x709 (>= block_num_q2 block_num_q1)))
 (let (($x711 (>= awq1_1 0)))
 (let (($x713 (and (>= awq1_0 0) $x711 (>= awq1_2 0))))
 (let (($x715 (and (and (>= xa_q 0) (<= xa_q 2) (>= xn_q2 0)) $x713 $x709 (ite $x584 $x700 (and (ite $x705 $x700 $x690))))))
 (let (($x716 (not $x715)))
 (let (($x861 (= oracleq0 oracleq1)))
 (let (($x718 (= awq1_2 t_awq1_0_2)))
 (let (($x721 (and (= awq1_0 t_awq1_0_0) (= awq1_1 t_awq1_0_1) $x718)))
 (let (($x722 (= wq1 t_wq1_0)))
 (let (($x862 (and $x722 $x721 $x861)))
 (let (($x673 (and (ite (= xa_q 0) (= t_awq1_0_0 (+ awq0_0 pay_amount1_q)) (= t_awq1_0_0 awq0_0)) (ite (= xa_q 1) (= t_awq1_0_1 (+ awq0_1 pay_amount1_q)) (= t_awq1_0_1 awq0_1)) (ite (= xa_q 2) (= t_awq1_0_2 (+ awq0_2 pay_amount1_q)) (= t_awq1_0_2 awq0_2)))))
 (let (($x877 (= t_wq1_0 (- wq0 pay_amount1_q))))
 (let (($x885 (and (= wq1 wq0) (and (= awq1_0 awq0_0) (= awq1_1 awq0_1) (= awq1_2 awq0_2)) $x861)))
 (let (($x748 (not (>= pay_amount1_q 0))))
 (let (($x671 (and (and (ite $x748 $x885 (and (and $x877 $x673) true $x862)) true $x862))))
 (let (($x890 (not (<= pay_amount1_q wq0))))
 (let (($x757 (not (= xn_q1 0))))
 (let (($x894 (>= block_num_q1 block_num_q0)))
 (let (($x895 (>= awq0_2 0)))
 (let (($x898 (and (>= awq0_0 0) (>= awq0_1 0) $x895)))
 (let (($x597 (and (and (>= xa_q 0) (<= xa_q 2) (>= xn_q1 0)) $x898 $x894 (ite $x757 $x885 (and (ite $x890 $x885 $x671))))))
 (let (($x598 (not $x597)))
 (let (($x1407 (= oracle_2 oracleq0)))
 (let (($x906 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x907 (= wq0 t_wq0_0)))
 (let (($x1408 (and $x907 $x906 $x1407)))
 (let (($x1176 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_2_0 pay_amount0_q)) (= t_awq0_0_0 aw_2_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_2_1 pay_amount0_q)) (= t_awq0_0_1 aw_2_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_2_2 pay_amount0_q)) (= t_awq0_0_2 aw_2_2)))))
 (let (($x1431 (and (= wq0 w_2) (and (= awq0_0 aw_2_0) (= awq0_1 aw_2_1) (= awq0_2 aw_2_2)) $x1407)))
 (let (($x933 (not (>= pay_amount0_q 0))))
 (let (($x1155 (and (ite $x933 $x1431 (and (and (= t_wq0_0 (- w_2 pay_amount0_q)) $x1176) true $x1408)) true $x1408)))
 (let (($x942 (not (= xn_q0 0))))
 (let (($x290 (>= aw_2_2 0)))
 (let (($x289 (>= aw_2_1 0)))
 (let (($x288 (>= aw_2_0 0)))
 (let (($x291 (and $x288 $x289 $x290)))
 ...
 (let (($x703 (<= xa_q 2)))
 (let (($x706 (>= xa_q 0)))
 (let (($x618 (and $x706 $x703 $x945)))
 (let (($x1000 (and $x618 $x291 (>= block_num_q0 block_num_2) (ite $x942 $x1431 (and (ite (not (<= pay_amount0_q w_2)) $x1431 (and $x1155)))))))
 (or (not $x1000) $x598 $x716 $x1303)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

...
(assert
 ...
 (let (($x629 (not $x628)))
 (let (($x1753 (= oracle_3 oracleq0)))
 (let (($x1106 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x1107 (= wq0 t_wq0_0)))
 (let (($x1754 (and $x1107 $x1106 $x1753)))
 (let (($x1676 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_3_0 pay_amount0_q)) (= t_awq0_0_0 aw_3_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_3_1 pay_amount0_q)) (= t_awq0_0_1 aw_3_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_3_2 pay_amount0_q)) (= t_awq0_0_2 aw_3_2)))))
 (let (($x1777 (and (= wq0 w_3) (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2)) $x1753)))
 (let (($x1132 (>= pay_amount0_q 0)))
 (let (($x1133 (not $x1132)))
 (let (($x1467 (and (ite $x1133 $x1777 (and (and (= t_wq0_0 (- w_3 pay_amount0_q)) $x1676) true $x1754)) true $x1754)))
 ...
 (let (($x1368 (and $x635 $x374 (>= block_num_q0 block_num_3) (ite $x1142 $x1777 (and (ite (not (<= pay_amount0_q w_3)) $x1777 (and $x1467)))))))
 (or (not $x1368) $x629 $x860 $x901 $x1315)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

...
(assert
 (let (($x1622 (exists ((xa_q Int) )(let (($x1619 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) )(let (($x1514 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_3_0 w_3)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_3_1 w_3)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_3_2 w_3)))))))
 (let (($x1569 (= oracle_3 oracleq0)))
 (let (($x545 (= awq0_2 t_awq0_0_2)))
 (let (($x546 (= awq0_1 t_awq0_0_1)))
 (let (($x547 (= awq0_0 t_awq0_0_0)))
 (let (($x548 (and $x547 $x546 $x545)))
 (let (($x549 (= wq0 t_wq0_0)))
 (let (($x1464 (and $x549 $x548 $x1569)))
 (let (($x1666 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_3_0 pay_amount0_q)) (= t_awq0_0_0 aw_3_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_3_1 pay_amount0_q)) (= t_awq0_0_1 aw_3_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_3_2 pay_amount0_q)) (= t_awq0_0_2 aw_3_2)))))
 (let (($x1497 (and (= wq0 w_3) (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2)) $x1569)))
 (let (($x575 (not (>= pay_amount0_q 0))))
 (let (($x1649 (and (ite $x575 $x1497 (and (and (= t_wq0_0 (- w_3 pay_amount0_q)) $x1666) true $x1464)) true $x1464)))
 (let (($x584 (not (= xn_q0 0))))
 (let (($x373 (>= aw_3_2 0)))
 (let (($x372 (>= aw_3_1 0)))
 (let (($x371 (>= aw_3_0 0)))
 (let (($x374 (and $x371 $x372 $x373)))
 (let (($x587 (>= xn_q0 0)))
 (let (($x483 (and (>= xa_q 0) (<= xa_q 2) $x587)))
 (let (($x1628 (and $x483 $x374 (>= block_num_q0 block_num_3) (ite $x584 $x1497 (and (ite (not (<= pay_amount0_q w_3)) $x1497 (and $x1649)))))))
 (or (not $x1628) $x1514))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

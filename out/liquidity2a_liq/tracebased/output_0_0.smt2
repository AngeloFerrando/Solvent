...
(assert
 (let (($x492 (exists ((xa_q Int) )(let (($x487 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) )(let (($x458 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_1_0 w_1)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_1_1 w_1)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_1_2 w_1)))))))
 (let (($x544 (= oracle_1 oracleq0)))
 ...
 (let (($x550 (and $x549 $x548 $x544)))
 (let (($x469 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_1_0 pay_amount0_q)) (= t_awq0_0_0 aw_1_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_1_1 pay_amount0_q)) (= t_awq0_0_1 aw_1_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_1_2 pay_amount0_q)) (= t_awq0_0_2 aw_1_2)))))
 (let (($x573 (and (= wq0 w_1) (and (= awq0_0 aw_1_0) (= awq0_1 aw_1_1) (= awq0_2 aw_1_2)) $x544)))
 (let (($x575 (not (>= pay_amount0_q 0))))
 (let (($x474 (and (ite $x575 $x573 (and (and (= t_wq0_0 (- w_1 pay_amount0_q)) $x469) true $x550)) true $x550)))
 ...
 (let (($x484 (and $x483 $x206 (>= block_num_q0 block_num_1) (ite $x584 $x573 (and (ite (not (<= pay_amount0_q w_1)) $x573 (and $x474)))))))
 (or (not $x484) $x458))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

...
(assert
 (let (($x1301 (exists ((xa_q Int) )(let (($x1290 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) )(let (($x1092 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_2_0 w_2)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_2_1 w_2)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_2_2 w_2)))))))
 (let (($x1229 (= oracle_2 oracleq0)))
 ...
 (let (($x1200 (and $x549 $x548 $x1229)))
 (let (($x1362 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_2_0 pay_amount0_q)) (= t_awq0_0_0 aw_2_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_2_1 pay_amount0_q)) (= t_awq0_0_1 aw_2_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_2_2 pay_amount0_q)) (= t_awq0_0_2 aw_2_2)))))
 (let (($x797 (and (= wq0 w_2) (and (= awq0_0 aw_2_0) (= awq0_1 aw_2_1) (= awq0_2 aw_2_2)) $x1229)))
 (let (($x575 (not (>= pay_amount0_q 0))))
 (let (($x1340 (and (ite $x575 $x797 (and (and (= t_wq0_0 (- w_2 pay_amount0_q)) $x1362) true $x1200)) true $x1200)))
 ...
 (let (($x1314 (and $x483 $x291 (>= block_num_q0 block_num_2) (ite $x584 $x797 (and (ite (not (<= pay_amount0_q w_2)) $x797 (and $x1340)))))))
 (or (not $x1314) $x1092))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

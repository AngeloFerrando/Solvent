...
(assert
 (let (($x1398 (exists ((xa_q Int) )(let (($x1395 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (block_num_q1 Int) (pay_amount1_q Int) (oracleq1 Int) (t_oracleq1_0 Int) (xn_q2 Int) (f_q2 Proc) (wq2 Int) (awq2_0 Int) (awq2_1 Int) (awq2_2 Int) (t_wq2_0 Int) (t_awq2_0_0 Int) (t_awq2_0_1 Int) (t_awq2_0_2 Int) (block_num_q2 Int) (pay_amount2_q Int) (oracleq2 Int) (t_oracleq2_0 Int) (xn_q3 Int) (f_q3 Proc) (wq3 Int) (awq3_0 Int) (awq3_1 Int) (awq3_2 Int) (t_wq3_0 Int) (t_awq3_0_0 Int) (t_awq3_0_1 Int) (t_awq3_0_2 Int) (block_num_q3 Int) (pay_amount3_q Int) (oracleq3 Int) (t_oracleq3_0 Int) )(let (($x998 (and (or (and (distinct xa_q 0) true) (not (= awq3_0 (+ aw_2_0 w_2)))) (or (and (distinct xa_q 1) true) (not (= awq3_1 (+ aw_2_1 w_2)))) (or (and (distinct xa_q 2) true) (not (= awq3_2 (+ aw_2_2 w_2)))))))
 (let (($x676 (= oracleq2 oracleq3)))
 (let (($x545 (= awq3_2 t_awq3_0_2)))
 (let (($x546 (= awq3_1 t_awq3_0_1)))
 (let (($x547 (= awq3_0 t_awq3_0_0)))
 (let (($x548 (and $x547 $x546 $x545)))
 (let (($x549 (= wq3 t_wq3_0)))
 (let (($x677 (and $x549 $x548 $x676)))
 (let (($x936 (and (ite (= xa_q 0) (= t_awq3_0_0 (+ awq2_0 pay_amount3_q)) (= t_awq3_0_0 awq2_0)) (ite (= xa_q 1) (= t_awq3_0_1 (+ awq2_1 pay_amount3_q)) (= t_awq3_0_1 awq2_1)) (ite (= xa_q 2) (= t_awq3_0_2 (+ awq2_2 pay_amount3_q)) (= t_awq3_0_2 awq2_2)))))
 (let (($x692 (= t_wq3_0 (- wq2 pay_amount3_q))))
 (let (($x700 (and (= wq3 wq2) (and (= awq3_0 awq2_0) (= awq3_1 awq2_1) (= awq3_2 awq2_2)) $x676)))
 (let (($x575 (not (>= pay_amount3_q 0))))
 (let (($x875 (and (and (ite $x575 $x700 (and (and $x692 $x936) true $x677)) true $x677))))
 (let (($x705 (not (<= pay_amount3_q wq2))))
 (let (($x584 (not (= xn_q3 0))))
 (let (($x709 (>= block_num_q3 block_num_q2)))
 (let (($x711 (>= awq2_1 0)))
 (let (($x713 (and (>= awq2_0 0) $x711 (>= awq2_2 0))))
 (let (($x900 (and (and (>= xa_q 0) (<= xa_q 2) (>= xn_q3 0)) $x713 $x709 (ite $x584 $x700 (and (ite $x705 $x700 $x875))))))
 (let (($x901 (not $x900)))
 (let (($x861 (= oracleq1 oracleq2)))
 (let (($x718 (= awq2_2 t_awq2_0_2)))
 (let (($x721 (and (= awq2_0 t_awq2_0_0) (= awq2_1 t_awq2_0_1) $x718)))
 (let (($x722 (= wq2 t_wq2_0)))
 (let (($x862 (and $x722 $x721 $x861)))
 (let (($x846 (and (ite (= xa_q 0) (= t_awq2_0_0 (+ awq1_0 pay_amount2_q)) (= t_awq2_0_0 awq1_0)) (ite (= xa_q 1) (= t_awq2_0_1 (+ awq1_1 pay_amount2_q)) (= t_awq2_0_1 awq1_1)) (ite (= xa_q 2) (= t_awq2_0_2 (+ awq1_2 pay_amount2_q)) (= t_awq2_0_2 awq1_2)))))
 (let (($x877 (= t_wq2_0 (- wq1 pay_amount2_q))))
 (let (($x885 (and (= wq2 wq1) (and (= awq2_0 awq1_0) (= awq2_1 awq1_1) (= awq2_2 awq1_2)) $x861)))
 (let (($x748 (not (>= pay_amount2_q 0))))
 (let (($x853 (and (and (ite $x748 $x885 (and (and $x877 $x846) true $x862)) true $x862))))
 (let (($x890 (not (<= pay_amount2_q wq1))))
 (let (($x757 (not (= xn_q2 0))))
 (let (($x894 (>= block_num_q2 block_num_q1)))
 (let (($x896 (>= awq1_1 0)))
 (let (($x898 (and (>= awq1_0 0) $x896 (>= awq1_2 0))))
 (let (($x859 (and (and (>= xa_q 0) (<= xa_q 2) (>= xn_q2 0)) $x898 $x894 (ite $x757 $x885 (and (ite $x890 $x885 $x853))))))
 (let (($x860 (not $x859)))
 (let (($x1061 (= oracleq0 oracleq1)))
 (let (($x906 (and (= awq1_0 t_awq1_0_0) (= awq1_1 t_awq1_0_1) (= awq1_2 t_awq1_0_2))))
 (let (($x907 (= wq1 t_wq1_0)))
 (let (($x1062 (and $x907 $x906 $x1061)))
 (let (($x843 (and (ite (= xa_q 0) (= t_awq1_0_0 (+ awq0_0 pay_amount1_q)) (= t_awq1_0_0 awq0_0)) (ite (= xa_q 1) (= t_awq1_0_1 (+ awq0_1 pay_amount1_q)) (= t_awq1_0_1 awq0_1)) (ite (= xa_q 2) (= t_awq1_0_2 (+ awq0_2 pay_amount1_q)) (= t_awq1_0_2 awq0_2)))))
 (let (($x1077 (= t_wq1_0 (- wq0 pay_amount1_q))))
 (let (($x1085 (and (= wq1 wq0) (and (= awq1_0 awq0_0) (= awq1_1 awq0_1) (= awq1_2 awq0_2)) $x1061)))
 (let (($x933 (not (>= pay_amount1_q 0))))
 (let (($x841 (and (and (ite $x933 $x1085 (and (and $x1077 $x843) true $x1062)) true $x1062))))
 (let (($x1090 (not (<= pay_amount1_q wq0))))
 (let (($x942 (not (= xn_q1 0))))
 (let (($x1094 (>= block_num_q1 block_num_q0)))
 (let (($x1098 (and (>= awq0_0 0) (>= awq0_1 0) (>= awq0_2 0))))
 (let (($x628 (and (and (>= xa_q 0) (<= xa_q 2) (>= xn_q1 0)) $x1098 $x1094 (ite $x942 $x1085 (and (ite $x1090 $x1085 $x841))))))
 (let (($x629 (not $x628)))
 (let (($x1519 (= oracle_2 oracleq0)))
 (let (($x1106 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x1107 (= wq0 t_wq0_0)))
 (let (($x1520 (and $x1107 $x1106 $x1519)))
 (let (($x1442 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_2_0 pay_amount0_q)) (= t_awq0_0_0 aw_2_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_2_1 pay_amount0_q)) (= t_awq0_0_1 aw_2_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_2_2 pay_amount0_q)) (= t_awq0_0_2 aw_2_2)))))
 (let (($x1543 (and (= wq0 w_2) (and (= awq0_0 aw_2_0) (= awq0_1 aw_2_1) (= awq0_2 aw_2_2)) $x1519)))
 (let (($x1132 (>= pay_amount0_q 0)))
 (let (($x1133 (not $x1132)))
 (let (($x1425 (and (ite $x1133 $x1543 (and (and (= t_wq0_0 (- w_2 pay_amount0_q)) $x1442) true $x1520)) true $x1520)))
 (let (($x1142 (not (= xn_q0 0))))
 (let (($x290 (>= aw_2_2 0)))
 (let (($x289 (>= aw_2_1 0)))
 (let (($x288 (>= aw_2_0 0)))
 (let (($x291 (and $x288 $x289 $x290)))
 ...
 (let (($x888 (<= xa_q 2)))
 (let (($x891 (>= xa_q 0)))
 (let (($x635 (and $x891 $x888 $x1145)))
 (let (($x1404 (and $x635 $x291 (>= block_num_q0 block_num_2) (ite $x1142 $x1543 (and (ite (not (<= pay_amount0_q w_2)) $x1543 (and $x1425)))))))
 (or (not $x1404) $x629 $x860 $x901 $x998)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x488 (<= xa_q 2)))
 (let (($x489 (>= xa_q 0)))

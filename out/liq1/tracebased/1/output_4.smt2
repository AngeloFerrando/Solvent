...
(assert
 ...
 (let (($x1730 (and $x1729)))
 (let (($x2071 (ite $x1695 $x1663 (and (and (ite (not (= oracle_2 oracleq3)) $x1663 $x1730) true $x1699)))))
 (let (($x1424 (= f_q4 win)))
 (let (($x1426 (= t_par2q4_0 par2q4)))
 (let (($x1740 (and $x1390 $x1661 $x1647 $x1646 $x1645 $x1426)))
 (let (($x2036 (ite (not (and (distinct oracle_2 par1q3) true)) $x1663 (and (and (= t_par2q4_0 oracle_2) true $x1740)))))
 ...
 (let (($x2164 (and $x2163)))
 (let (($x2856 (ite $x2129 $x2097 (and (and (ite (not (= oracle_2 oracleq2)) $x2097 $x2164) true $x2133)))))
 (let (($x1860 (= f_q3 win)))
 (let (($x1862 (= t_par2q3_0 par2q3)))
 (let (($x2174 (and $x1826 $x2095 $x2081 $x2080 $x2079 $x1862)))
 (let (($x2864 (ite (not (and (distinct oracle_2 par1q2) true)) $x2097 (and (and (= t_par2q3_0 oracle_2) true $x2174)))))
 ...
 (let (($x2598 (and $x2597)))
 (let (($x3408 (ite $x2563 $x2531 (and (and (ite (not (= oracle_2 oracleq1)) $x2531 $x2598) true $x2567)))))
 (let (($x2294 (= f_q2 win)))
 (let (($x2296 (= t_par2q2_0 par2q2)))
 (let (($x2608 (and $x2260 $x2529 $x2515 $x2514 $x2513 $x2296)))
 (let (($x3416 (ite (not (and (distinct oracle_2 par1q1) true)) $x2531 (and (and (= t_par2q2_0 oracle_2) true $x2608)))))
 (let (($x2304 (= xn_q2 1)))
 (let (($x2305 (not $x2304)))
 (let (($x2309 (= t_wq2_0 1)))
 (let (($x2310 (not $x2309)))
 ...
 (let (($x3032 (and $x3031)))
 (let (($x3692 (ite $x2997 $x2965 (and (and (ite (not (= oracle_2 oracleq0)) $x2965 $x3032) true $x3001)))))
 (let (($x2728 (= f_q1 win)))
 (let (($x2730 (= t_par2q1_0 par2q1)))
 (let (($x3042 (and $x2694 $x2963 $x2949 $x2948 $x2947 $x2730)))
 (let (($x3700 (ite (not (and (distinct oracle_2 par1q0) true)) $x2965 (and (and (= t_par2q1_0 oracle_2) true $x3042)))))
 (let (($x2739 (not (= xn_q1 1))))
 (let (($x2744 (not (= t_wq1_0 1))))
 (let (($x3706 (ite $x2744 $x2965 (and (and (ite $x2739 $x2965 (and (and $x3700 true $x3042))) true $x3042)))))
 (let (($x3056 (= t_wq1_0 (+ wq0 xn_q1))))
 (let (($x2750 (= f_q1 join)))
 (let (($x3709 (ite $x2750 (and $x3056 (and $x3706)) (ite $x2728 (ite $x2688 $x2965 (and $x3692)) $x3000))))
 (let (($x3059 (>= block_num_q1 block_num_q0)))
 (let (($x3063 (and (>= awq0_0 0) (>= awq0_1 0) (>= awq0_2 0))))
 (let (($x2753 (>= xn_q1 0)))
 (let (($x3516 (and $x1140 $x1159 $x2753)))
 (let (($x3712 (= par2_2 par2q0)))
 (let (($x3713 (= par1_2 par1q0)))
 (let (($x3714 (= deadline_2 deadlineq0)))
 (let (($x3687 (= oracle_2 oracleq0)))
 (let (($x3072 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x3073 (= wq0 t_wq0_1)))
 (let (($x3715 (and $x3073 $x3072 $x3687 $x3714 $x3713 $x3712)))
 (let (($x3719 (and (ite (= par2_2 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_2 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_2 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x3089 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x3725 (and (= awq0_0 aw_2_0) (= awq0_1 aw_2_1) (= awq0_2 aw_2_2))))
 (let (($x3727 (and (= wq0 w_2) $x3725 $x3687 $x3714 $x3713 $x3712)))
 (let (($x3730 (= t_awq0_0_2 aw_2_2)))
 (let (($x740 (= par1_2 2)))
 (let (($x3733 (= t_awq0_0_1 aw_2_1)))
 (let (($x736 (= par1_2 1)))
 (let (($x3736 (= t_awq0_0_0 aw_2_0)))
 (let (($x732 (= par1_2 0)))
 (let (($x3739 (and (ite $x732 (= t_awq0_0_0 (+ aw_2_0 1)) $x3736) (ite $x736 (= t_awq0_0_1 (+ aw_2_1 1)) $x3733) (ite $x740 (= t_awq0_0_2 (+ aw_2_2 1)) $x3730))))
 (let (($x3742 (and (and (= t_wq0_0 (- w_2 1)) $x3739) (and (ite $x483 $x3727 (and (and $x3089 $x3719) true $x3715)) true $x3715))))
 (let (($x729 (not (>= block_num_2 deadline_2))))
 (let (($x3747 (and (ite $x729 $x3727 (and (and (ite $x483 $x3727 $x3742) true $x3715))) true $x3715)))
 (let (($x676 (= w_2 2)))
 (let (($x677 (not $x676)))
 (let (($x3122 (not (= xn_q0 0))))
 (let (($x3127 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x3128 (= wq0 t_wq0_0)))
 (let (($x3752 (and $x3128 $x3127 $x3687 $x3714 $x3713 $x3712)))
 (let (($x3759 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_2_0 w_2)) $x3736) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_2_1 w_2)) $x3733) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_2_2 w_2)) $x3730))))
 (let (($x686 (>= w_2 0)))
 (let (($x687 (not $x686)))
 (let (($x3763 (ite $x687 $x3727 (and (and (= t_wq0_0 (- w_2 w_2)) $x3759) true $x3752))))
 (let (($x3770 (ite (not (or (= win_winner0_q par1_2) (= win_winner0_q par2_2))) $x3727 (and (and $x3763 true $x3752)))))
 (let (($x680 (< block_num_2 deadline_2)))
 (let (($x681 (not $x680)))
 (let (($x1193 (not (= oracle_2 oracle_2))))
 (let (($x3776 (ite $x1193 $x3727 (and (and (ite $x681 $x3727 (and (and $x3770 true $x3752))) true $x3752)))))
 (let (($x3162 (= f_q0 win)))
 (let (($x3782 (ite $x3162 (ite $x3122 $x3727 (and (ite $x677 $x3727 (and (and $x3776 true $x3752))))) (ite $x3122 $x3727 (and (ite $x677 $x3727 (and $x3747)))))))
 (let (($x3164 (= t_par2q0_0 par2q0)))
 (let (($x3783 (and $x3128 $x3725 $x3687 $x3714 $x3713 $x3164)))
 (let (($x1173 (not (and (distinct oracle_2 par1_2) true))))
 (let (($x3788 (and (ite $x1173 $x3727 (and (and (= t_par2q0_0 oracle_2) true $x3783))) true $x3783)))
 (let (($x3173 (not (= xn_q0 1))))
 (let (($x3178 (not (= t_wq0_0 1))))
 (let (($x3794 (and (ite $x3178 $x3727 (and (and (ite $x3173 $x3727 (and $x3788)) true $x3783))))))
 (let (($x3184 (= f_q0 join)))
 (let (($x636 (>= aw_2_2 0)))
 (let (($x635 (>= aw_2_1 0)))
 (let (($x634 (>= aw_2_0 0)))
 (let (($x637 (and $x634 $x635 $x636)))
 (let (($x3801 (and (and $x1140 $x1159 (>= xn_q0 0)) $x637 (>= block_num_q0 block_num_2) (ite $x3184 (and (= t_wq0_0 (+ w_2 xn_q0)) $x3794) $x3782))))
 (or (not $x3801) (not (and $x3516 $x3063 $x3059 $x3709)) $x3427 $x2875 $x2054 $x1503)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x676 (= w_2 2)))
 (let (($x680 (< block_num_2 deadline_2)))

...
(assert
 (let (($x1143 (exists ((xa_q Int) )(let (($x2030 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_wq0_1 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (t_awq0_1_0 Int) (t_awq0_1_1 Int) (t_awq0_1_2 Int) (block_num_q0 Int) (win_winner0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) (t_oracleq0_1 Int) (deadlineq0 Int) (t_deadlineq0_0 Int) (t_deadlineq0_1 Int) (par1q0 Int) (t_par1q0_0 Int) (t_par1q0_1 Int) (par2q0 Int) (t_par2q0_0 Int) (t_par2q0_1 Int) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_wq1_1 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (t_awq1_1_0 Int) (t_awq1_1_1 Int) (t_awq1_1_2 Int) (block_num_q1 Int) (win_winner1_q Int) (oracleq1 Int) (t_oracleq1_0 Int) (t_oracleq1_1 Int) (deadlineq1 Int) (t_deadlineq1_0 Int) (t_deadlineq1_1 Int) (par1q1 Int) (t_par1q1_0 Int) (t_par1q1_1 Int) (par2q1 Int) (t_par2q1_0 Int) (t_par2q1_1 Int) )(let (($x1498 (and (or (and (distinct par2_2 0) true) (not (>= (- awq1_0 aw_2_0) 2))) (or (and (distinct par2_2 1) true) (not (>= (- awq1_1 aw_2_1) 2))) (or (and (distinct par2_2 2) true) (not (>= (- awq1_2 aw_2_2) 2))))))
 (let (($x1502 (and (or (and (distinct par1_2 0) true) (not (>= (- awq1_0 aw_2_0) 2))) (or (and (distinct par1_2 1) true) (not (>= (- awq1_1 aw_2_1) 2))) (or (and (distinct par1_2 2) true) (not (>= (- awq1_2 aw_2_2) 2))))))
 ...
 (let (($x1730 (and $x1729)))
 (let (($x2071 (ite $x1695 $x1663 (and (and (ite (not (= oracle_2 oracleq0)) $x1663 $x1730) true $x1699)))))
 (let (($x1424 (= f_q1 win)))
 (let (($x1426 (= t_par2q1_0 par2q1)))
 (let (($x1740 (and $x1390 $x1661 $x1647 $x1646 $x1645 $x1426)))
 (let (($x2036 (ite (not (and (distinct oracle_2 par1q0) true)) $x1663 (and (and (= t_par2q1_0 oracle_2) true $x1740)))))
 ...
 (let (($x2324 (= par2_2 par2q0)))
 (let (($x2325 (= par1_2 par1q0)))
 (let (($x2326 (= deadline_2 deadlineq0)))
 (let (($x2031 (= oracle_2 oracleq0)))
 (let (($x1770 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x1771 (= wq0 t_wq0_1)))
 (let (($x2327 (and $x1771 $x1770 $x2031 $x2326 $x2325 $x2324)))
 (let (($x2331 (and (ite (= par2_2 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_2 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_2 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x1787 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x2337 (and (= awq0_0 aw_2_0) (= awq0_1 aw_2_1) (= awq0_2 aw_2_2))))
 (let (($x2339 (and (= wq0 w_2) $x2337 $x2031 $x2326 $x2325 $x2324)))
 (let (($x2342 (= t_awq0_0_2 aw_2_2)))
 (let (($x740 (= par1_2 2)))
 (let (($x2345 (= t_awq0_0_1 aw_2_1)))
 (let (($x736 (= par1_2 1)))
 (let (($x2348 (= t_awq0_0_0 aw_2_0)))
 (let (($x732 (= par1_2 0)))
 (let (($x2351 (and (ite $x732 (= t_awq0_0_0 (+ aw_2_0 1)) $x2348) (ite $x736 (= t_awq0_0_1 (+ aw_2_1 1)) $x2345) (ite $x740 (= t_awq0_0_2 (+ aw_2_2 1)) $x2342))))
 (let (($x2354 (and (and (= t_wq0_0 (- w_2 1)) $x2351) (and (ite $x483 $x2339 (and (and $x1787 $x2331) true $x2327)) true $x2327))))
 (let (($x729 (not (>= block_num_2 deadline_2))))
 (let (($x2359 (and (ite $x729 $x2339 (and (and (ite $x483 $x2339 $x2354) true $x2327))) true $x2327)))
 (let (($x676 (= w_2 2)))
 (let (($x677 (not $x676)))
 (let (($x1820 (not (= xn_q0 0))))
 (let (($x1825 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x1826 (= wq0 t_wq0_0)))
 (let (($x2364 (and $x1826 $x1825 $x2031 $x2326 $x2325 $x2324)))
 (let (($x2371 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_2_0 w_2)) $x2348) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_2_1 w_2)) $x2345) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_2_2 w_2)) $x2342))))
 (let (($x686 (>= w_2 0)))
 (let (($x687 (not $x686)))
 (let (($x2375 (ite $x687 $x2339 (and (and (= t_wq0_0 (- w_2 w_2)) $x2371) true $x2364))))
 (let (($x2382 (ite (not (or (= win_winner0_q par1_2) (= win_winner0_q par2_2))) $x2339 (and (and $x2375 true $x2364)))))
 (let (($x680 (< block_num_2 deadline_2)))
 (let (($x681 (not $x680)))
 (let (($x1193 (not (= oracle_2 oracle_2))))
 (let (($x2388 (ite $x1193 $x2339 (and (and (ite $x681 $x2339 (and (and $x2382 true $x2364))) true $x2364)))))
 (let (($x1860 (= f_q0 win)))
 (let (($x2394 (ite $x1860 (ite $x1820 $x2339 (and (ite $x677 $x2339 (and (and $x2388 true $x2364))))) (ite $x1820 $x2339 (and (ite $x677 $x2339 (and $x2359)))))))
 (let (($x1862 (= t_par2q0_0 par2q0)))
 (let (($x2395 (and $x1826 $x2337 $x2031 $x2326 $x2325 $x1862)))
 (let (($x1173 (not (and (distinct oracle_2 par1_2) true))))
 (let (($x2400 (and (ite $x1173 $x2339 (and (and (= t_par2q0_0 oracle_2) true $x2395))) true $x2395)))
 (let (($x1871 (not (= xn_q0 1))))
 (let (($x1876 (not (= t_wq0_0 1))))
 (let (($x2406 (and (ite $x1876 $x2339 (and (and (ite $x1871 $x2339 (and $x2400)) true $x2395))))))
 (let (($x1882 (= f_q0 join)))
 (let (($x636 (>= aw_2_2 0)))
 (let (($x635 (>= aw_2_1 0)))
 (let (($x634 (>= aw_2_0 0)))
 ...
 (let (($x2413 (and $x2412 $x637 (>= block_num_q0 block_num_2) (ite $x1882 (and (= t_wq0_0 (+ w_2 xn_q0)) $x2406) $x2394))))
 (or (not $x2413) $x2054 $x1503))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x676 (= w_2 2)))
 (let (($x680 (< block_num_2 deadline_2)))

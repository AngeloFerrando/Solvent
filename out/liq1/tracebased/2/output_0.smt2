...
(assert
 (let (($x1184 (exists ((xa_q Int) )(let (($x1639 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_wq0_1 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (t_awq0_1_0 Int) (t_awq0_1_1 Int) (t_awq0_1_2 Int) (block_num_q0 Int) (win_winner0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) (t_oracleq0_1 Int) (deadlineq0 Int) (t_deadlineq0_0 Int) (t_deadlineq0_1 Int) (par1q0 Int) (t_par1q0_0 Int) (t_par1q0_1 Int) (par2q0 Int) (t_par2q0_0 Int) (t_par2q0_1 Int) )(let (($x1906 (and (or (and (distinct par2_3 0) true) (not (>= (- awq0_0 aw_3_0) 2))) (or (and (distinct par2_3 1) true) (not (>= (- awq0_1 aw_3_1) 2))) (or (and (distinct par2_3 2) true) (not (>= (- awq0_2 aw_3_2) 2))))))
 (let (($x1910 (and (or (and (distinct par1_3 0) true) (not (>= (- awq0_0 aw_3_0) 2))) (or (and (distinct par1_3 1) true) (not (>= (- awq0_1 aw_3_1) 2))) (or (and (distinct par1_3 2) true) (not (>= (- awq0_2 aw_3_2) 2))))))
 (let (($x1911 (or $x1910 $x1906)))
 (let (($x1912 (= par2_3 par2q0)))
 (let (($x1913 (= par1_3 par1q0)))
 (let (($x1914 (= deadline_3 deadlineq0)))
 (let (($x1915 (= oracle_3 oracleq0)))
 (let (($x1334 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x1335 (= wq0 t_wq0_1)))
 (let (($x1916 (and $x1335 $x1334 $x1915 $x1914 $x1913 $x1912)))
 (let (($x1920 (and (ite (= par2_3 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_3 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_3 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x1351 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x1926 (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2))))
 (let (($x1928 (and (= wq0 w_3) $x1926 $x1915 $x1914 $x1913 $x1912)))
 (let (($x483 (not true)))
 (let (($x1931 (= t_awq0_0_2 aw_3_2)))
 (let (($x985 (= par1_3 2)))
 (let (($x1934 (= t_awq0_0_1 aw_3_1)))
 (let (($x981 (= par1_3 1)))
 (let (($x1937 (= t_awq0_0_0 aw_3_0)))
 (let (($x977 (= par1_3 0)))
 (let (($x1940 (and (ite $x977 (= t_awq0_0_0 (+ aw_3_0 1)) $x1937) (ite $x981 (= t_awq0_0_1 (+ aw_3_1 1)) $x1934) (ite $x985 (= t_awq0_0_2 (+ aw_3_2 1)) $x1931))))
 (let (($x1943 (and (and (= t_wq0_0 (- w_3 1)) $x1940) (and (ite $x483 $x1928 (and (and $x1351 $x1920) true $x1916)) true $x1916))))
 (let (($x974 (not (>= block_num_3 deadline_3))))
 (let (($x1948 (and (ite $x974 $x1928 (and (and (ite $x483 $x1928 $x1943) true $x1916))) true $x1916)))
 (let (($x921 (= w_3 2)))
 (let (($x922 (not $x921)))
 (let (($x1384 (not (= xn_q0 0))))
 (let (($x1389 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x1390 (= wq0 t_wq0_0)))
 (let (($x1953 (and $x1390 $x1389 $x1915 $x1914 $x1913 $x1912)))
 (let (($x1960 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_3_0 w_3)) $x1937) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_3_1 w_3)) $x1934) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_3_2 w_3)) $x1931))))
 (let (($x931 (>= w_3 0)))
 (let (($x932 (not $x931)))
 (let (($x1964 (ite $x932 $x1928 (and (and (= t_wq0_0 (- w_3 w_3)) $x1960) true $x1953))))
 (let (($x1971 (ite (not (or (= win_winner0_q par1_3) (= win_winner0_q par2_3))) $x1928 (and (and $x1964 true $x1953)))))
 (let (($x925 (< block_num_3 deadline_3)))
 (let (($x926 (not $x925)))
 (let (($x1215 (not (= oracle_3 oracle_3))))
 (let (($x1977 (ite $x1215 $x1928 (and (and (ite $x926 $x1928 (and (and $x1971 true $x1953))) true $x1953)))))
 (let (($x1424 (= f_q0 win)))
 (let (($x1983 (ite $x1424 (ite $x1384 $x1928 (and (ite $x922 $x1928 (and (and $x1977 true $x1953))))) (ite $x1384 $x1928 (and (ite $x922 $x1928 (and $x1948)))))))
 (let (($x1426 (= t_par2q0_0 par2q0)))
 (let (($x1984 (and $x1390 $x1926 $x1915 $x1914 $x1913 $x1426)))
 (let (($x1195 (not (and (distinct oracle_3 par1_3) true))))
 (let (($x1989 (and (ite $x1195 $x1928 (and (and (= t_par2q0_0 oracle_3) true $x1984))) true $x1984)))
 (let (($x1435 (not (= xn_q0 1))))
 (let (($x1440 (not (= t_wq0_0 1))))
 (let (($x1995 (and (ite $x1440 $x1928 (and (and (ite $x1435 $x1928 (and $x1989)) true $x1984))))))
 (let (($x1446 (= f_q0 join)))
 (let (($x881 (>= aw_3_2 0)))
 (let (($x880 (>= aw_3_1 0)))
 (let (($x879 (>= aw_3_0 0)))
 ...
 (let (($x2002 (and $x2001 $x882 (>= block_num_q0 block_num_3) (ite $x1446 (and (= t_wq0_0 (+ w_3 xn_q0)) $x1995) $x1983))))
 (or (not $x2002) $x1911)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x921 (= w_3 2)))
 (let (($x925 (< block_num_3 deadline_3)))

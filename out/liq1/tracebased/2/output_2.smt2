...
(assert
 ...
 (let (($x1730 (and $x1729)))
 (let (($x2844 (ite $x1695 $x1663 (and (and (ite (not (= oracle_3 oracleq1)) $x1663 $x1730) true $x1699)))))
 (let (($x1424 (= f_q2 win)))
 (let (($x1426 (= t_par2q2_0 par2q2)))
 (let (($x1740 (and $x1390 $x1661 $x1647 $x1646 $x1645 $x1426)))
 (let (($x2830 (ite (not (and (distinct oracle_3 par1q1) true)) $x1663 (and (and (= t_par2q2_0 oracle_3) true $x1740)))))
 ...
 (let (($x2164 (and $x2163)))
 (let (($x3618 (ite $x2129 $x2097 (and (and (ite (not (= oracle_3 oracleq0)) $x2097 $x2164) true $x2133)))))
 (let (($x1860 (= f_q1 win)))
 (let (($x1862 (= t_par2q1_0 par2q1)))
 (let (($x2174 (and $x1826 $x2095 $x2081 $x2080 $x2079 $x1862)))
 (let (($x3626 (ite (not (and (distinct oracle_3 par1q0) true)) $x2097 (and (and (= t_par2q1_0 oracle_3) true $x2174)))))
 ...
 (let (($x3638 (= par2_3 par2q0)))
 (let (($x3639 (= par1_3 par1q0)))
 (let (($x3640 (= deadline_3 deadlineq0)))
 (let (($x3613 (= oracle_3 oracleq0)))
 (let (($x2204 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x2205 (= wq0 t_wq0_1)))
 (let (($x3641 (and $x2205 $x2204 $x3613 $x3640 $x3639 $x3638)))
 (let (($x3645 (and (ite (= par2_3 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_3 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_3 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x2221 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x3651 (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2))))
 (let (($x3685 (and (= wq0 w_3) $x3651 $x3613 $x3640 $x3639 $x3638)))
 (let (($x3682 (= t_awq0_0_2 aw_3_2)))
 (let (($x985 (= par1_3 2)))
 (let (($x3679 (= t_awq0_0_1 aw_3_1)))
 (let (($x981 (= par1_3 1)))
 (let (($x3676 (= t_awq0_0_0 aw_3_0)))
 (let (($x977 (= par1_3 0)))
 (let (($x3673 (and (ite $x977 (= t_awq0_0_0 (+ aw_3_0 1)) $x3676) (ite $x981 (= t_awq0_0_1 (+ aw_3_1 1)) $x3679) (ite $x985 (= t_awq0_0_2 (+ aw_3_2 1)) $x3682))))
 (let (($x3670 (and (and (= t_wq0_0 (- w_3 1)) $x3673) (and (ite $x483 $x3685 (and (and $x2221 $x3645) true $x3641)) true $x3641))))
 (let (($x974 (not (>= block_num_3 deadline_3))))
 (let (($x3665 (and (ite $x974 $x3685 (and (and (ite $x483 $x3685 $x3670) true $x3641))) true $x3641)))
 (let (($x921 (= w_3 2)))
 (let (($x922 (not $x921)))
 (let (($x2254 (not (= xn_q0 0))))
 (let (($x2259 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x2260 (= wq0 t_wq0_0)))
 (let (($x3660 (and $x2260 $x2259 $x3613 $x3640 $x3639 $x3638)))
 (let (($x3653 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_3_0 w_3)) $x3676) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_3_1 w_3)) $x3679) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_3_2 w_3)) $x3682))))
 (let (($x931 (>= w_3 0)))
 (let (($x932 (not $x931)))
 (let (($x3807 (ite $x932 $x3685 (and (and (= t_wq0_0 (- w_3 w_3)) $x3653) true $x3660))))
 (let (($x3814 (ite (not (or (= win_winner0_q par1_3) (= win_winner0_q par2_3))) $x3685 (and (and $x3807 true $x3660)))))
 (let (($x925 (< block_num_3 deadline_3)))
 (let (($x926 (not $x925)))
 (let (($x1215 (not (= oracle_3 oracle_3))))
 (let (($x3820 (ite $x1215 $x3685 (and (and (ite $x926 $x3685 (and (and $x3814 true $x3660))) true $x3660)))))
 (let (($x2294 (= f_q0 win)))
 (let (($x3826 (ite $x2294 (ite $x2254 $x3685 (and (ite $x922 $x3685 (and (and $x3820 true $x3660))))) (ite $x2254 $x3685 (and (ite $x922 $x3685 (and $x3665)))))))
 (let (($x2296 (= t_par2q0_0 par2q0)))
 (let (($x3827 (and $x2260 $x3651 $x3613 $x3640 $x3639 $x2296)))
 (let (($x1195 (not (and (distinct oracle_3 par1_3) true))))
 (let (($x3832 (and (ite $x1195 $x3685 (and (and (= t_par2q0_0 oracle_3) true $x3827))) true $x3827)))
 (let (($x2305 (not (= xn_q0 1))))
 (let (($x2310 (not (= t_wq0_0 1))))
 (let (($x3838 (and (ite $x2310 $x3685 (and (and (ite $x2305 $x3685 (and $x3832)) true $x3827))))))
 (let (($x2316 (= f_q0 join)))
 (let (($x881 (>= aw_3_2 0)))
 (let (($x880 (>= aw_3_1 0)))
 (let (($x879 (>= aw_3_0 0)))
 ...
 (let (($x3845 (and $x3844 $x882 (>= block_num_q0 block_num_3) (ite $x2316 (and (= t_wq0_0 (+ w_3 xn_q0)) $x3838) $x3826))))
 (or (not $x3845) $x3637 $x2831 $x1911)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x921 (= w_3 2)))
 (let (($x925 (< block_num_3 deadline_3)))

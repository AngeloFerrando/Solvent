...
(assert
 ...
 (let (($x1730 (and $x1729)))
 (let (($x2844 (ite $x1695 $x1663 (and (and (ite (not (= oracle_3 oracleq2)) $x1663 $x1730) true $x1699)))))
 (let (($x1424 (= f_q3 win)))
 (let (($x1426 (= t_par2q3_0 par2q3)))
 (let (($x1740 (and $x1390 $x1661 $x1647 $x1646 $x1645 $x1426)))
 (let (($x2830 (ite (not (and (distinct oracle_3 par1q2) true)) $x1663 (and (and (= t_par2q3_0 oracle_3) true $x1740)))))
 ...
 (let (($x2164 (and $x2163)))
 (let (($x3618 (ite $x2129 $x2097 (and (and (ite (not (= oracle_3 oracleq1)) $x2097 $x2164) true $x2133)))))
 (let (($x1860 (= f_q2 win)))
 (let (($x1862 (= t_par2q2_0 par2q2)))
 (let (($x2174 (and $x1826 $x2095 $x2081 $x2080 $x2079 $x1862)))
 (let (($x3626 (ite (not (and (distinct oracle_3 par1q1) true)) $x2097 (and (and (= t_par2q2_0 oracle_3) true $x2174)))))
 ...
 (let (($x2598 (and $x2597)))
 (let (($x4020 (ite $x2563 $x2531 (and (and (ite (not (= oracle_3 oracleq0)) $x2531 $x2598) true $x2567)))))
 (let (($x2294 (= f_q1 win)))
 (let (($x2296 (= t_par2q1_0 par2q1)))
 (let (($x2608 (and $x2260 $x2529 $x2515 $x2514 $x2513 $x2296)))
 (let (($x4028 (ite (not (and (distinct oracle_3 par1q0) true)) $x2531 (and (and (= t_par2q1_0 oracle_3) true $x2608)))))
 (let (($x2304 (= xn_q1 1)))
 (let (($x2305 (not $x2304)))
 (let (($x2309 (= t_wq1_0 1)))
 (let (($x2310 (not $x2309)))
 ...
 (let (($x4040 (= par2_3 par2q0)))
 (let (($x4041 (= par1_3 par1q0)))
 (let (($x4042 (= deadline_3 deadlineq0)))
 (let (($x4015 (= oracle_3 oracleq0)))
 (let (($x2638 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x2639 (= wq0 t_wq0_1)))
 (let (($x4043 (and $x2639 $x2638 $x4015 $x4042 $x4041 $x4040)))
 (let (($x4047 (and (ite (= par2_3 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_3 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_3 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x2655 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x4053 (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2))))
 (let (($x4055 (and (= wq0 w_3) $x4053 $x4015 $x4042 $x4041 $x4040)))
 (let (($x4058 (= t_awq0_0_2 aw_3_2)))
 (let (($x985 (= par1_3 2)))
 (let (($x4061 (= t_awq0_0_1 aw_3_1)))
 (let (($x981 (= par1_3 1)))
 (let (($x4064 (= t_awq0_0_0 aw_3_0)))
 (let (($x977 (= par1_3 0)))
 (let (($x4067 (and (ite $x977 (= t_awq0_0_0 (+ aw_3_0 1)) $x4064) (ite $x981 (= t_awq0_0_1 (+ aw_3_1 1)) $x4061) (ite $x985 (= t_awq0_0_2 (+ aw_3_2 1)) $x4058))))
 (let (($x4070 (and (and (= t_wq0_0 (- w_3 1)) $x4067) (and (ite $x483 $x4055 (and (and $x2655 $x4047) true $x4043)) true $x4043))))
 (let (($x974 (not (>= block_num_3 deadline_3))))
 (let (($x4075 (and (ite $x974 $x4055 (and (and (ite $x483 $x4055 $x4070) true $x4043))) true $x4043)))
 (let (($x921 (= w_3 2)))
 (let (($x922 (not $x921)))
 (let (($x2688 (not (= xn_q0 0))))
 (let (($x2693 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x2694 (= wq0 t_wq0_0)))
 (let (($x4080 (and $x2694 $x2693 $x4015 $x4042 $x4041 $x4040)))
 (let (($x4087 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_3_0 w_3)) $x4064) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_3_1 w_3)) $x4061) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_3_2 w_3)) $x4058))))
 (let (($x931 (>= w_3 0)))
 (let (($x932 (not $x931)))
 (let (($x4091 (ite $x932 $x4055 (and (and (= t_wq0_0 (- w_3 w_3)) $x4087) true $x4080))))
 (let (($x4098 (ite (not (or (= win_winner0_q par1_3) (= win_winner0_q par2_3))) $x4055 (and (and $x4091 true $x4080)))))
 (let (($x925 (< block_num_3 deadline_3)))
 (let (($x926 (not $x925)))
 (let (($x1215 (not (= oracle_3 oracle_3))))
 (let (($x4104 (ite $x1215 $x4055 (and (and (ite $x926 $x4055 (and (and $x4098 true $x4080))) true $x4080)))))
 (let (($x2728 (= f_q0 win)))
 (let (($x4110 (ite $x2728 (ite $x2688 $x4055 (and (ite $x922 $x4055 (and (and $x4104 true $x4080))))) (ite $x2688 $x4055 (and (ite $x922 $x4055 (and $x4075)))))))
 (let (($x2730 (= t_par2q0_0 par2q0)))
 (let (($x4111 (and $x2694 $x4053 $x4015 $x4042 $x4041 $x2730)))
 (let (($x1195 (not (and (distinct oracle_3 par1_3) true))))
 (let (($x4116 (and (ite $x1195 $x4055 (and (and (= t_par2q0_0 oracle_3) true $x4111))) true $x4111)))
 (let (($x2739 (not (= xn_q0 1))))
 (let (($x2744 (not (= t_wq0_0 1))))
 (let (($x4122 (and (ite $x2744 $x4055 (and (and (ite $x2739 $x4055 (and $x4116)) true $x4111))))))
 (let (($x2750 (= f_q0 join)))
 (let (($x881 (>= aw_3_2 0)))
 (let (($x880 (>= aw_3_1 0)))
 (let (($x879 (>= aw_3_0 0)))
 ...
 (let (($x4129 (and $x4128 $x882 (>= block_num_q0 block_num_3) (ite $x2750 (and (= t_wq0_0 (+ w_3 xn_q0)) $x4122) $x4110))))
 (or (not $x4129) $x4039 $x3637 $x2831 $x1911)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x921 (= w_3 2)))
 (let (($x925 (< block_num_3 deadline_3)))

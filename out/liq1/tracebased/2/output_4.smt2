...
(assert
 ...
 (let (($x1730 (and $x1729)))
 (let (($x2844 (ite $x1695 $x1663 (and (and (ite (not (= oracle_3 oracleq3)) $x1663 $x1730) true $x1699)))))
 (let (($x1424 (= f_q4 win)))
 (let (($x1426 (= t_par2q4_0 par2q4)))
 (let (($x1740 (and $x1390 $x1661 $x1647 $x1646 $x1645 $x1426)))
 (let (($x2830 (ite (not (and (distinct oracle_3 par1q3) true)) $x1663 (and (and (= t_par2q4_0 oracle_3) true $x1740)))))
 (let (($x1435 (not (= xn_q4 1))))
 (let (($x1440 (not (= t_wq4_0 1))))
 (let (($x2836 (ite $x1440 $x1663 (and (and (ite $x1435 $x1663 (and (and $x2830 true $x1740))) true $x1740)))))
 (let (($x1754 (= t_wq4_0 (+ wq3 xn_q4))))
 (let (($x1446 (= f_q4 join)))
 (let (($x2833 (ite $x1446 (and $x1754 (and $x2836)) (ite $x1424 (ite $x1384 $x1663 (and $x2844)) $x1698))))
 (let (($x1757 (>= block_num_q4 block_num_q3)))
 (let (($x1761 (and (>= awq3_0 0) (>= awq3_1 0) (>= awq3_2 0))))
 (let (($x1449 (>= xn_q4 0)))
 (let (($x1181 (<= oracle_3 2)))
 (let (($x1152 (>= oracle_3 0)))
 (let (($x2001 (and $x1152 $x1181 $x1449)))
 (let (($x2831 (not (and $x2001 $x1761 $x1757 $x2833))))
 ...
 (let (($x2164 (and $x2163)))
 (let (($x3618 (ite $x2129 $x2097 (and (and (ite (not (= oracle_3 oracleq2)) $x2097 $x2164) true $x2133)))))
 (let (($x1860 (= f_q3 win)))
 (let (($x1862 (= t_par2q3_0 par2q3)))
 (let (($x2174 (and $x1826 $x2095 $x2081 $x2080 $x2079 $x1862)))
 (let (($x3626 (ite (not (and (distinct oracle_3 par1q2) true)) $x2097 (and (and (= t_par2q3_0 oracle_3) true $x2174)))))
 (let (($x1871 (not (= xn_q3 1))))
 (let (($x1876 (not (= t_wq3_0 1))))
 (let (($x3632 (ite $x1876 $x2097 (and (and (ite $x1871 $x2097 (and (and $x3626 true $x2174))) true $x2174)))))
 (let (($x2188 (= t_wq3_0 (+ wq2 xn_q3))))
 (let (($x1882 (= f_q3 join)))
 (let (($x3635 (ite $x1882 (and $x2188 (and $x3632)) (ite $x1860 (ite $x1820 $x2097 (and $x3618)) $x2132))))
 ...
 (let (($x1885 (>= xn_q3 0)))
 (let (($x3324 (and $x1152 $x1181 $x1885)))
 (let (($x3637 (not (and $x3324 $x2195 $x2191 $x3635))))
 ...
 (let (($x2598 (and $x2597)))
 (let (($x4020 (ite $x2563 $x2531 (and (and (ite (not (= oracle_3 oracleq1)) $x2531 $x2598) true $x2567)))))
 (let (($x2294 (= f_q2 win)))
 (let (($x2296 (= t_par2q2_0 par2q2)))
 (let (($x2608 (and $x2260 $x2529 $x2515 $x2514 $x2513 $x2296)))
 (let (($x4028 (ite (not (and (distinct oracle_3 par1q1) true)) $x2531 (and (and (= t_par2q2_0 oracle_3) true $x2608)))))
 (let (($x2304 (= xn_q2 1)))
 (let (($x2305 (not $x2304)))
 (let (($x2309 (= t_wq2_0 1)))
 (let (($x2310 (not $x2309)))
 (let (($x4034 (ite $x2310 $x2531 (and (and (ite $x2305 $x2531 (and (and $x4028 true $x2608))) true $x2608)))))
 (let (($x2622 (= t_wq2_0 (+ wq1 xn_q2))))
 (let (($x2316 (= f_q2 join)))
 (let (($x4037 (ite $x2316 (and $x2622 (and $x4034)) (ite $x2294 (ite $x2254 $x2531 (and $x4020)) $x2566))))
 (let (($x2625 (>= block_num_q2 block_num_q1)))
 (let (($x2629 (and (>= awq1_0 0) (>= awq1_1 0) (>= awq1_2 0))))
 (let (($x2319 (>= xn_q2 0)))
 (let (($x3844 (and $x1152 $x1181 $x2319)))
 (let (($x4039 (not (and $x3844 $x2629 $x2625 $x4037))))
 ...
 (let (($x3032 (and $x3031)))
 (let (($x4304 (ite $x2997 $x2965 (and (and (ite (not (= oracle_3 oracleq0)) $x2965 $x3032) true $x3001)))))
 (let (($x2728 (= f_q1 win)))
 (let (($x2730 (= t_par2q1_0 par2q1)))
 (let (($x3042 (and $x2694 $x2963 $x2949 $x2948 $x2947 $x2730)))
 (let (($x4312 (ite (not (and (distinct oracle_3 par1q0) true)) $x2965 (and (and (= t_par2q1_0 oracle_3) true $x3042)))))
 (let (($x2739 (not (= xn_q1 1))))
 (let (($x2744 (not (= t_wq1_0 1))))
 (let (($x4318 (ite $x2744 $x2965 (and (and (ite $x2739 $x2965 (and (and $x4312 true $x3042))) true $x3042)))))
 (let (($x3056 (= t_wq1_0 (+ wq0 xn_q1))))
 (let (($x2750 (= f_q1 join)))
 (let (($x4321 (ite $x2750 (and $x3056 (and $x4318)) (ite $x2728 (ite $x2688 $x2965 (and $x4304)) $x3000))))
 (let (($x3059 (>= block_num_q1 block_num_q0)))
 (let (($x3063 (and (>= awq0_0 0) (>= awq0_1 0) (>= awq0_2 0))))
 (let (($x2753 (>= xn_q1 0)))
 (let (($x4128 (and $x1152 $x1181 $x2753)))
 (let (($x4324 (= par2_3 par2q0)))
 (let (($x4325 (= par1_3 par1q0)))
 (let (($x4326 (= deadline_3 deadlineq0)))
 (let (($x4299 (= oracle_3 oracleq0)))
 (let (($x3072 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x3073 (= wq0 t_wq0_1)))
 (let (($x4327 (and $x3073 $x3072 $x4299 $x4326 $x4325 $x4324)))
 (let (($x4331 (and (ite (= par2_3 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_3 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_3 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x3089 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x4337 (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2))))
 (let (($x4339 (and (= wq0 w_3) $x4337 $x4299 $x4326 $x4325 $x4324)))
 (let (($x4342 (= t_awq0_0_2 aw_3_2)))
 (let (($x985 (= par1_3 2)))
 (let (($x4345 (= t_awq0_0_1 aw_3_1)))
 (let (($x981 (= par1_3 1)))
 (let (($x4348 (= t_awq0_0_0 aw_3_0)))
 (let (($x977 (= par1_3 0)))
 (let (($x4351 (and (ite $x977 (= t_awq0_0_0 (+ aw_3_0 1)) $x4348) (ite $x981 (= t_awq0_0_1 (+ aw_3_1 1)) $x4345) (ite $x985 (= t_awq0_0_2 (+ aw_3_2 1)) $x4342))))
 (let (($x4354 (and (and (= t_wq0_0 (- w_3 1)) $x4351) (and (ite $x483 $x4339 (and (and $x3089 $x4331) true $x4327)) true $x4327))))
 (let (($x974 (not (>= block_num_3 deadline_3))))
 (let (($x4359 (and (ite $x974 $x4339 (and (and (ite $x483 $x4339 $x4354) true $x4327))) true $x4327)))
 (let (($x921 (= w_3 2)))
 (let (($x922 (not $x921)))
 (let (($x3122 (not (= xn_q0 0))))
 (let (($x3127 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x3128 (= wq0 t_wq0_0)))
 (let (($x4364 (and $x3128 $x3127 $x4299 $x4326 $x4325 $x4324)))
 (let (($x4371 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_3_0 w_3)) $x4348) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_3_1 w_3)) $x4345) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_3_2 w_3)) $x4342))))
 (let (($x931 (>= w_3 0)))
 (let (($x932 (not $x931)))
 (let (($x4375 (ite $x932 $x4339 (and (and (= t_wq0_0 (- w_3 w_3)) $x4371) true $x4364))))
 (let (($x4382 (ite (not (or (= win_winner0_q par1_3) (= win_winner0_q par2_3))) $x4339 (and (and $x4375 true $x4364)))))
 (let (($x925 (< block_num_3 deadline_3)))
 (let (($x926 (not $x925)))
 (let (($x1215 (not (= oracle_3 oracle_3))))
 (let (($x4388 (ite $x1215 $x4339 (and (and (ite $x926 $x4339 (and (and $x4382 true $x4364))) true $x4364)))))
 (let (($x3162 (= f_q0 win)))
 (let (($x4394 (ite $x3162 (ite $x3122 $x4339 (and (ite $x922 $x4339 (and (and $x4388 true $x4364))))) (ite $x3122 $x4339 (and (ite $x922 $x4339 (and $x4359)))))))
 (let (($x3164 (= t_par2q0_0 par2q0)))
 (let (($x4395 (and $x3128 $x4337 $x4299 $x4326 $x4325 $x3164)))
 (let (($x1195 (not (and (distinct oracle_3 par1_3) true))))
 (let (($x4400 (and (ite $x1195 $x4339 (and (and (= t_par2q0_0 oracle_3) true $x4395))) true $x4395)))
 (let (($x3173 (not (= xn_q0 1))))
 (let (($x3178 (not (= t_wq0_0 1))))
 (let (($x4406 (and (ite $x3178 $x4339 (and (and (ite $x3173 $x4339 (and $x4400)) true $x4395))))))
 (let (($x3184 (= f_q0 join)))
 (let (($x881 (>= aw_3_2 0)))
 (let (($x880 (>= aw_3_1 0)))
 (let (($x879 (>= aw_3_0 0)))
 (let (($x882 (and $x879 $x880 $x881)))
 (let (($x4413 (and (and $x1152 $x1181 (>= xn_q0 0)) $x882 (>= block_num_q0 block_num_3) (ite $x3184 (and (= t_wq0_0 (+ w_3 xn_q0)) $x4406) $x4394))))
 (or (not $x4413) (not (and $x4128 $x3063 $x3059 $x4321)) $x4039 $x3637 $x2831 $x1911)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x921 (= w_3 2)))
 (let (($x925 (< block_num_3 deadline_3)))
 (let (($x1179 (and $x925 $x921)))
 (let (($x1128 (<= xa_q 2)))
 (let (($x1129 (>= xa_q 0)))
 (let (($x1130 (and $x1129 $x1128)))
 (and $x1130 $x1179 $x4298)))))))))
 ))
 (and $x1200)))
(check-sat)

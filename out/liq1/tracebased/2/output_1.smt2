...
(assert
 (let (($x1161 (exists ((xa_q Int) )(let (($x2824 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_wq0_1 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (t_awq0_1_0 Int) (t_awq0_1_1 Int) (t_awq0_1_2 Int) (block_num_q0 Int) (win_winner0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) (t_oracleq0_1 Int) (deadlineq0 Int) (t_deadlineq0_0 Int) (t_deadlineq0_1 Int) (par1q0 Int) (t_par1q0_0 Int) (t_par1q0_1 Int) (par2q0 Int) (t_par2q0_0 Int) (t_par2q0_1 Int) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_wq1_1 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (t_awq1_1_0 Int) (t_awq1_1_1 Int) (t_awq1_1_2 Int) (block_num_q1 Int) (win_winner1_q Int) (oracleq1 Int) (t_oracleq1_0 Int) (t_oracleq1_1 Int) (deadlineq1 Int) (t_deadlineq1_0 Int) (t_deadlineq1_1 Int) (par1q1 Int) (t_par1q1_0 Int) (t_par1q1_1 Int) (par2q1 Int) (t_par2q1_0 Int) (t_par2q1_1 Int) )(let (($x1906 (and (or (and (distinct par2_3 0) true) (not (>= (- awq1_0 aw_3_0) 2))) (or (and (distinct par2_3 1) true) (not (>= (- awq1_1 aw_3_1) 2))) (or (and (distinct par2_3 2) true) (not (>= (- awq1_2 aw_3_2) 2))))))
 (let (($x1910 (and (or (and (distinct par1_3 0) true) (not (>= (- awq1_0 aw_3_0) 2))) (or (and (distinct par1_3 1) true) (not (>= (- awq1_1 aw_3_1) 2))) (or (and (distinct par1_3 2) true) (not (>= (- awq1_2 aw_3_2) 2))))))
 ...
 (let (($x1730 (and $x1729)))
 (let (($x2844 (ite $x1695 $x1663 (and (and (ite (not (= oracle_3 oracleq0)) $x1663 $x1730) true $x1699)))))
 (let (($x1424 (= f_q1 win)))
 (let (($x1426 (= t_par2q1_0 par2q1)))
 (let (($x1740 (and $x1390 $x1661 $x1647 $x1646 $x1645 $x1426)))
 (let (($x2830 (ite (not (and (distinct oracle_3 par1q0) true)) $x1663 (and (and (= t_par2q1_0 oracle_3) true $x1740)))))
 ...
 (let (($x3236 (= par2_3 par2q0)))
 (let (($x3237 (= par1_3 par1q0)))
 (let (($x3238 (= deadline_3 deadlineq0)))
 (let (($x2825 (= oracle_3 oracleq0)))
 (let (($x1770 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x1771 (= wq0 t_wq0_1)))
 (let (($x3239 (and $x1771 $x1770 $x2825 $x3238 $x3237 $x3236)))
 (let (($x3243 (and (ite (= par2_3 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_3 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_3 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x1787 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x3249 (and (= awq0_0 aw_3_0) (= awq0_1 aw_3_1) (= awq0_2 aw_3_2))))
 (let (($x3251 (and (= wq0 w_3) $x3249 $x2825 $x3238 $x3237 $x3236)))
 (let (($x3254 (= t_awq0_0_2 aw_3_2)))
 (let (($x985 (= par1_3 2)))
 (let (($x3257 (= t_awq0_0_1 aw_3_1)))
 (let (($x981 (= par1_3 1)))
 (let (($x3260 (= t_awq0_0_0 aw_3_0)))
 (let (($x977 (= par1_3 0)))
 (let (($x3263 (and (ite $x977 (= t_awq0_0_0 (+ aw_3_0 1)) $x3260) (ite $x981 (= t_awq0_0_1 (+ aw_3_1 1)) $x3257) (ite $x985 (= t_awq0_0_2 (+ aw_3_2 1)) $x3254))))
 (let (($x3266 (and (and (= t_wq0_0 (- w_3 1)) $x3263) (and (ite $x483 $x3251 (and (and $x1787 $x3243) true $x3239)) true $x3239))))
 (let (($x974 (not (>= block_num_3 deadline_3))))
 (let (($x3271 (and (ite $x974 $x3251 (and (and (ite $x483 $x3251 $x3266) true $x3239))) true $x3239)))
 (let (($x921 (= w_3 2)))
 (let (($x922 (not $x921)))
 (let (($x1820 (not (= xn_q0 0))))
 (let (($x1825 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x1826 (= wq0 t_wq0_0)))
 (let (($x3276 (and $x1826 $x1825 $x2825 $x3238 $x3237 $x3236)))
 (let (($x3283 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_3_0 w_3)) $x3260) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_3_1 w_3)) $x3257) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_3_2 w_3)) $x3254))))
 (let (($x931 (>= w_3 0)))
 (let (($x932 (not $x931)))
 (let (($x3287 (ite $x932 $x3251 (and (and (= t_wq0_0 (- w_3 w_3)) $x3283) true $x3276))))
 (let (($x3294 (ite (not (or (= win_winner0_q par1_3) (= win_winner0_q par2_3))) $x3251 (and (and $x3287 true $x3276)))))
 (let (($x925 (< block_num_3 deadline_3)))
 (let (($x926 (not $x925)))
 (let (($x1215 (not (= oracle_3 oracle_3))))
 (let (($x3300 (ite $x1215 $x3251 (and (and (ite $x926 $x3251 (and (and $x3294 true $x3276))) true $x3276)))))
 (let (($x1860 (= f_q0 win)))
 (let (($x3306 (ite $x1860 (ite $x1820 $x3251 (and (ite $x922 $x3251 (and (and $x3300 true $x3276))))) (ite $x1820 $x3251 (and (ite $x922 $x3251 (and $x3271)))))))
 (let (($x1862 (= t_par2q0_0 par2q0)))
 (let (($x3307 (and $x1826 $x3249 $x2825 $x3238 $x3237 $x1862)))
 (let (($x1195 (not (and (distinct oracle_3 par1_3) true))))
 (let (($x3312 (and (ite $x1195 $x3251 (and (and (= t_par2q0_0 oracle_3) true $x3307))) true $x3307)))
 (let (($x1871 (not (= xn_q0 1))))
 (let (($x1876 (not (= t_wq0_0 1))))
 (let (($x3318 (and (ite $x1876 $x3251 (and (and (ite $x1871 $x3251 (and $x3312)) true $x3307))))))
 (let (($x1882 (= f_q0 join)))
 (let (($x881 (>= aw_3_2 0)))
 (let (($x880 (>= aw_3_1 0)))
 (let (($x879 (>= aw_3_0 0)))
 ...
 (let (($x3325 (and $x3324 $x882 (>= block_num_q0 block_num_3) (ite $x1882 (and (= t_wq0_0 (+ w_3 xn_q0)) $x3318) $x3306))))
 (or (not $x3325) $x2831 $x1911))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x921 (= w_3 2)))
 (let (($x925 (< block_num_3 deadline_3)))

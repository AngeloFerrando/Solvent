...
(assert
 ...
 (let (($x1730 (and $x1729)))
 (let (($x1736 (ite $x1695 $x1663 (and (and (ite (not (= oracle_1 oracleq1)) $x1663 $x1730) true $x1699)))))
 (let (($x1424 (= f_q2 win)))
 (let (($x1426 (= t_par2q2_0 par2q2)))
 (let (($x1740 (and $x1390 $x1661 $x1647 $x1646 $x1645 $x1426)))
 (let (($x1745 (ite (not (and (distinct oracle_1 par1q1) true)) $x1663 (and (and (= t_par2q2_0 oracle_1) true $x1740)))))
 ...
 (let (($x2164 (and $x2163)))
 (let (($x2170 (ite $x2129 $x2097 (and (and (ite (not (= oracle_1 oracleq0)) $x2097 $x2164) true $x2133)))))
 (let (($x1860 (= f_q1 win)))
 (let (($x1862 (= t_par2q1_0 par2q1)))
 (let (($x2174 (and $x1826 $x2095 $x2081 $x2080 $x2079 $x1862)))
 (let (($x2179 (ite (not (and (distinct oracle_1 par1q0) true)) $x2097 (and (and (= t_par2q1_0 oracle_1) true $x2174)))))
 ...
 (let (($x2198 (= par2_1 par2q0)))
 (let (($x2199 (= par1_1 par1q0)))
 (let (($x2200 (= deadline_1 deadlineq0)))
 (let (($x2165 (= oracle_1 oracleq0)))
 (let (($x2204 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x2205 (= wq0 t_wq0_1)))
 (let (($x2206 (and $x2205 $x2204 $x2165 $x2200 $x2199 $x2198)))
 (let (($x2219 (and (ite (= par2_1 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_1 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_1 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x2221 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x2227 (and (= awq0_0 aw_1_0) (= awq0_1 aw_1_1) (= awq0_2 aw_1_2))))
 (let (($x2229 (and (= wq0 w_1) $x2227 $x2165 $x2200 $x2199 $x2198)))
 (let (($x2232 (= t_awq0_0_2 aw_1_2)))
 (let (($x494 (= par1_1 2)))
 (let (($x2235 (= t_awq0_0_1 aw_1_1)))
 (let (($x490 (= par1_1 1)))
 (let (($x2238 (= t_awq0_0_0 aw_1_0)))
 (let (($x486 (= par1_1 0)))
 (let (($x2241 (and (ite $x486 (= t_awq0_0_0 (+ aw_1_0 1)) $x2238) (ite $x490 (= t_awq0_0_1 (+ aw_1_1 1)) $x2235) (ite $x494 (= t_awq0_0_2 (+ aw_1_2 1)) $x2232))))
 (let (($x2244 (and (and (= t_wq0_0 (- w_1 1)) $x2241) (and (ite $x483 $x2229 (and (and $x2221 $x2219) true $x2206)) true $x2206))))
 (let (($x482 (not (>= block_num_1 deadline_1))))
 (let (($x2249 (and (ite $x482 $x2229 (and (and (ite $x483 $x2229 $x2244) true $x2206))) true $x2206)))
 (let (($x429 (= w_1 2)))
 (let (($x430 (not $x429)))
 (let (($x2254 (not (= xn_q0 0))))
 (let (($x2259 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x2260 (= wq0 t_wq0_0)))
 (let (($x2261 (and $x2260 $x2259 $x2165 $x2200 $x2199 $x2198)))
 (let (($x2271 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_1_0 w_1)) $x2238) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_1_1 w_1)) $x2235) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_1_2 w_1)) $x2232))))
 (let (($x439 (>= w_1 0)))
 (let (($x440 (not $x439)))
 (let (($x2275 (ite $x440 $x2229 (and (and (= t_wq0_0 (- w_1 w_1)) $x2271) true $x2261))))
 (let (($x2282 (ite (not (or (= win_winner0_q par1_1) (= win_winner0_q par2_1))) $x2229 (and (and $x2275 true $x2261)))))
 (let (($x433 (< block_num_1 deadline_1)))
 (let (($x434 (not $x433)))
 (let (($x1167 (not (= oracle_1 oracle_1))))
 (let (($x2288 (ite $x1167 $x2229 (and (and (ite $x434 $x2229 (and (and $x2282 true $x2261))) true $x2261)))))
 (let (($x2294 (= f_q0 win)))
 (let (($x2295 (ite $x2294 (ite $x2254 $x2229 (and (ite $x430 $x2229 (and (and $x2288 true $x2261))))) (ite $x2254 $x2229 (and (ite $x430 $x2229 (and $x2249)))))))
 (let (($x2296 (= t_par2q0_0 par2q0)))
 (let (($x2297 (and $x2260 $x2227 $x2165 $x2200 $x2199 $x2296)))
 (let (($x1147 (not (and (distinct oracle_1 par1_1) true))))
 (let (($x2302 (and (ite $x1147 $x2229 (and (and (= t_par2q0_0 oracle_1) true $x2297))) true $x2297)))
 (let (($x2305 (not (= xn_q0 1))))
 (let (($x2310 (not (= t_wq0_0 1))))
 (let (($x2312 (and (ite $x2310 $x2229 (and (and (ite $x2305 $x2229 (and $x2302)) true $x2297))))))
 (let (($x2316 (= f_q0 join)))
 (let (($x389 (>= aw_1_2 0)))
 (let (($x388 (>= aw_1_1 0)))
 (let (($x387 (>= aw_1_0 0)))
 ...
 (let (($x2321 (and $x2320 $x390 (>= block_num_q0 block_num_1) (ite $x2316 (and (= t_wq0_0 (+ w_1 xn_q0)) $x2312) $x2295))))
 (or (not $x2321) $x2197 $x1763 $x1326)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x429 (= w_1 2)))
 (let (($x433 (< block_num_1 deadline_1)))

...
(assert
 (let (($x1156 (exists ((xa_q Int) )(let (($x2945 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_wq0_1 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (t_awq0_1_0 Int) (t_awq0_1_1 Int) (t_awq0_1_2 Int) (block_num_q0 Int) (win_winner0_q Int) (oracleq0 Int) (t_oracleq0_0 Int) (t_oracleq0_1 Int) (deadlineq0 Int) (t_deadlineq0_0 Int) (t_deadlineq0_1 Int) (par1q0 Int) (t_par1q0_0 Int) (t_par1q0_1 Int) (par2q0 Int) (t_par2q0_0 Int) (t_par2q0_1 Int) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_wq1_1 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (t_awq1_1_0 Int) (t_awq1_1_1 Int) (t_awq1_1_2 Int) (block_num_q1 Int) (win_winner1_q Int) (oracleq1 Int) (t_oracleq1_0 Int) (t_oracleq1_1 Int) (deadlineq1 Int) (t_deadlineq1_0 Int) (t_deadlineq1_1 Int) (par1q1 Int) (t_par1q1_0 Int) (t_par1q1_1 Int) (par2q1 Int) (t_par2q1_0 Int) (t_par2q1_1 Int) (xn_q2 Int) (f_q2 Proc) (wq2 Int) (awq2_0 Int) (awq2_1 Int) (awq2_2 Int) (t_wq2_0 Int) (t_wq2_1 Int) (t_awq2_0_0 Int) (t_awq2_0_1 Int) (t_awq2_0_2 Int) (t_awq2_1_0 Int) (t_awq2_1_1 Int) (t_awq2_1_2 Int) (block_num_q2 Int) (win_winner2_q Int) (oracleq2 Int) (t_oracleq2_0 Int) (t_oracleq2_1 Int) (deadlineq2 Int) (t_deadlineq2_0 Int) (t_deadlineq2_1 Int) (par1q2 Int) (t_par1q2_0 Int) (t_par1q2_1 Int) (par2q2 Int) (t_par2q2_0 Int) (t_par2q2_1 Int) (xn_q3 Int) (f_q3 Proc) (wq3 Int) (awq3_0 Int) (awq3_1 Int) (awq3_2 Int) (t_wq3_0 Int) (t_wq3_1 Int) (t_awq3_0_0 Int) (t_awq3_0_1 Int) (t_awq3_0_2 Int) (t_awq3_1_0 Int) (t_awq3_1_1 Int) (t_awq3_1_2 Int) (block_num_q3 Int) (win_winner3_q Int) (oracleq3 Int) (t_oracleq3_0 Int) (t_oracleq3_1 Int) (deadlineq3 Int) (t_deadlineq3_0 Int) (t_deadlineq3_1 Int) (par1q3 Int) (t_par1q3_0 Int) (t_par1q3_1 Int) (par2q3 Int) (t_par2q3_0 Int) (t_par2q3_1 Int) (xn_q4 Int) (f_q4 Proc) (wq4 Int) (awq4_0 Int) (awq4_1 Int) (awq4_2 Int) (t_wq4_0 Int) (t_wq4_1 Int) (t_awq4_0_0 Int) (t_awq4_0_1 Int) (t_awq4_0_2 Int) (t_awq4_1_0 Int) (t_awq4_1_1 Int) (t_awq4_1_2 Int) (block_num_q4 Int) (win_winner4_q Int) (oracleq4 Int) (t_oracleq4_0 Int) (t_oracleq4_1 Int) (deadlineq4 Int) (t_deadlineq4_0 Int) (t_deadlineq4_1 Int) (par1q4 Int) (t_par1q4_0 Int) (t_par1q4_1 Int) (par2q4 Int) (t_par2q4_0 Int) (t_par2q4_1 Int) )(let (($x1321 (and (or (and (distinct par2_1 0) true) (not (>= (- awq4_0 aw_1_0) 2))) (or (and (distinct par2_1 1) true) (not (>= (- awq4_1 aw_1_1) 2))) (or (and (distinct par2_1 2) true) (not (>= (- awq4_2 aw_1_2) 2))))))
 (let (($x1325 (and (or (and (distinct par1_1 0) true) (not (>= (- awq4_0 aw_1_0) 2))) (or (and (distinct par1_1 1) true) (not (>= (- awq4_1 aw_1_1) 2))) (or (and (distinct par1_1 2) true) (not (>= (- awq4_2 aw_1_2) 2))))))
 (let (($x1326 (or $x1325 $x1321)))
 (let (($x1644 (= par2q3 par2q4)))
 (let (($x1645 (= par1q3 par1q4)))
 (let (($x1646 (= deadlineq3 deadlineq4)))
 (let (($x1647 (= oracleq3 oracleq4)))
 (let (($x1334 (and (= awq4_0 t_awq4_1_0) (= awq4_1 t_awq4_1_1) (= awq4_2 t_awq4_1_2))))
 (let (($x1335 (= wq4 t_wq4_1)))
 (let (($x1648 (and $x1335 $x1334 $x1647 $x1646 $x1645 $x1644)))
 (let (($x1655 (and (ite (= par2q3 0) (= t_awq4_1_0 (+ t_awq4_0_0 1)) (= t_awq4_1_0 t_awq4_0_0)) (ite (= par2q3 1) (= t_awq4_1_1 (+ t_awq4_0_1 1)) (= t_awq4_1_1 t_awq4_0_1)) (ite (= par2q3 2) (= t_awq4_1_2 (+ t_awq4_0_2 1)) (= t_awq4_1_2 t_awq4_0_2)))))
 (let (($x1351 (= t_wq4_1 (- t_wq4_0 1))))
 (let (($x1661 (and (= awq4_0 awq3_0) (= awq4_1 awq3_1) (= awq4_2 awq3_2))))
 (let (($x1663 (and (= wq4 wq3) $x1661 $x1647 $x1646 $x1645 $x1644)))
 (let (($x483 (not true)))
 (let (($x1681 (and (ite (= par1q3 0) (= t_awq4_0_0 (+ awq3_0 1)) (= t_awq4_0_0 awq3_0)) (ite (= par1q3 1) (= t_awq4_0_1 (+ awq3_1 1)) (= t_awq4_0_1 awq3_1)) (ite (= par1q3 2) (= t_awq4_0_2 (+ awq3_2 1)) (= t_awq4_0_2 awq3_2)))))
 (let (($x1685 (and (and (= t_wq4_0 (- wq3 1)) $x1681) (and (ite $x483 $x1663 (and (and $x1351 $x1655) true $x1648)) true $x1648))))
 (let (($x1691 (ite (not (>= block_num_q3 deadlineq3)) $x1663 (and (and (ite $x483 $x1663 $x1685) true $x1648)))))
 (let (($x1695 (not (= wq3 2))))
 (let (($x1384 (not (= xn_q4 0))))
 (let (($x1698 (ite $x1384 $x1663 (and (ite $x1695 $x1663 (and (and $x1691 true $x1648)))))))
 (let (($x1389 (and (= awq4_0 t_awq4_0_0) (= awq4_1 t_awq4_0_1) (= awq4_2 t_awq4_0_2))))
 (let (($x1390 (= wq4 t_wq4_0)))
 (let (($x1699 (and $x1390 $x1389 $x1647 $x1646 $x1645 $x1644)))
 (let (($x1709 (and (ite (= win_winner4_q 0) (= t_awq4_0_0 (+ awq3_0 wq3)) (= t_awq4_0_0 awq3_0)) (ite (= win_winner4_q 1) (= t_awq4_0_1 (+ awq3_1 wq3)) (= t_awq4_0_1 awq3_1)) (ite (= win_winner4_q 2) (= t_awq4_0_2 (+ awq3_2 wq3)) (= t_awq4_0_2 awq3_2)))))
 (let (($x1716 (ite (not (>= wq3 0)) $x1663 (and (and (= t_wq4_0 (- wq3 wq3)) $x1709) true $x1699))))
 (let (($x1723 (ite (not (or (= win_winner4_q par1q3) (= win_winner4_q par2q3))) $x1663 (and (and $x1716 true $x1699)))))
 (let (($x1729 (and (ite (not (< block_num_q3 deadlineq3)) $x1663 (and (and $x1723 true $x1699))) true $x1699)))
 (let (($x1730 (and $x1729)))
 (let (($x1736 (ite $x1695 $x1663 (and (and (ite (not (= oracle_1 oracleq3)) $x1663 $x1730) true $x1699)))))
 (let (($x1424 (= f_q4 win)))
 (let (($x1426 (= t_par2q4_0 par2q4)))
 (let (($x1740 (and $x1390 $x1661 $x1647 $x1646 $x1645 $x1426)))
 (let (($x1745 (ite (not (and (distinct oracle_1 par1q3) true)) $x1663 (and (and (= t_par2q4_0 oracle_1) true $x1740)))))
 (let (($x1435 (not (= xn_q4 1))))
 (let (($x1440 (not (= t_wq4_0 1))))
 (let (($x1751 (ite $x1440 $x1663 (and (and (ite $x1435 $x1663 (and (and $x1745 true $x1740))) true $x1740)))))
 (let (($x1754 (= t_wq4_0 (+ wq3 xn_q4))))
 (let (($x1446 (= f_q4 join)))
 (let (($x1756 (ite $x1446 (and $x1754 (and $x1751)) (ite $x1424 (ite $x1384 $x1663 (and $x1736)) $x1698))))
 (let (($x1757 (>= block_num_q4 block_num_q3)))
 (let (($x1761 (and (>= awq3_0 0) (>= awq3_1 0) (>= awq3_2 0))))
 (let (($x1449 (>= xn_q4 0)))
 (let (($x1125 (<= oracle_1 2)))
 (let (($x1124 (>= oracle_1 0)))
 (let (($x1450 (and $x1124 $x1125 $x1449)))
 (let (($x1763 (not (and $x1450 $x1761 $x1757 $x1756))))
 (let (($x2078 (= par2q2 par2q3)))
 (let (($x2079 (= par1q2 par1q3)))
 (let (($x2080 (= deadlineq2 deadlineq3)))
 (let (($x2081 (= oracleq2 oracleq3)))
 (let (($x1770 (and (= awq3_0 t_awq3_1_0) (= awq3_1 t_awq3_1_1) (= awq3_2 t_awq3_1_2))))
 (let (($x1771 (= wq3 t_wq3_1)))
 (let (($x2082 (and $x1771 $x1770 $x2081 $x2080 $x2079 $x2078)))
 (let (($x2089 (and (ite (= par2q2 0) (= t_awq3_1_0 (+ t_awq3_0_0 1)) (= t_awq3_1_0 t_awq3_0_0)) (ite (= par2q2 1) (= t_awq3_1_1 (+ t_awq3_0_1 1)) (= t_awq3_1_1 t_awq3_0_1)) (ite (= par2q2 2) (= t_awq3_1_2 (+ t_awq3_0_2 1)) (= t_awq3_1_2 t_awq3_0_2)))))
 (let (($x1787 (= t_wq3_1 (- t_wq3_0 1))))
 (let (($x2095 (and (= awq3_0 awq2_0) (= awq3_1 awq2_1) (= awq3_2 awq2_2))))
 (let (($x2097 (and (= wq3 wq2) $x2095 $x2081 $x2080 $x2079 $x2078)))
 (let (($x2115 (and (ite (= par1q2 0) (= t_awq3_0_0 (+ awq2_0 1)) (= t_awq3_0_0 awq2_0)) (ite (= par1q2 1) (= t_awq3_0_1 (+ awq2_1 1)) (= t_awq3_0_1 awq2_1)) (ite (= par1q2 2) (= t_awq3_0_2 (+ awq2_2 1)) (= t_awq3_0_2 awq2_2)))))
 (let (($x2119 (and (and (= t_wq3_0 (- wq2 1)) $x2115) (and (ite $x483 $x2097 (and (and $x1787 $x2089) true $x2082)) true $x2082))))
 (let (($x2125 (ite (not (>= block_num_q2 deadlineq2)) $x2097 (and (and (ite $x483 $x2097 $x2119) true $x2082)))))
 (let (($x2128 (= wq2 2)))
 (let (($x2129 (not $x2128)))
 (let (($x1820 (not (= xn_q3 0))))
 (let (($x2132 (ite $x1820 $x2097 (and (ite $x2129 $x2097 (and (and $x2125 true $x2082)))))))
 (let (($x1825 (and (= awq3_0 t_awq3_0_0) (= awq3_1 t_awq3_0_1) (= awq3_2 t_awq3_0_2))))
 (let (($x1826 (= wq3 t_wq3_0)))
 (let (($x2133 (and $x1826 $x1825 $x2081 $x2080 $x2079 $x2078)))
 (let (($x2143 (and (ite (= win_winner3_q 0) (= t_awq3_0_0 (+ awq2_0 wq2)) (= t_awq3_0_0 awq2_0)) (ite (= win_winner3_q 1) (= t_awq3_0_1 (+ awq2_1 wq2)) (= t_awq3_0_1 awq2_1)) (ite (= win_winner3_q 2) (= t_awq3_0_2 (+ awq2_2 wq2)) (= t_awq3_0_2 awq2_2)))))
 (let (($x2150 (ite (not (>= wq2 0)) $x2097 (and (and (= t_wq3_0 (- wq2 wq2)) $x2143) true $x2133))))
 (let (($x2157 (ite (not (or (= win_winner3_q par1q2) (= win_winner3_q par2q2))) $x2097 (and (and $x2150 true $x2133)))))
 (let (($x2163 (and (ite (not (< block_num_q2 deadlineq2)) $x2097 (and (and $x2157 true $x2133))) true $x2133)))
 (let (($x2164 (and $x2163)))
 (let (($x2170 (ite $x2129 $x2097 (and (and (ite (not (= oracle_1 oracleq2)) $x2097 $x2164) true $x2133)))))
 (let (($x1860 (= f_q3 win)))
 (let (($x1862 (= t_par2q3_0 par2q3)))
 (let (($x2174 (and $x1826 $x2095 $x2081 $x2080 $x2079 $x1862)))
 (let (($x2179 (ite (not (and (distinct oracle_1 par1q2) true)) $x2097 (and (and (= t_par2q3_0 oracle_1) true $x2174)))))
 (let (($x1871 (not (= xn_q3 1))))
 (let (($x1876 (not (= t_wq3_0 1))))
 (let (($x2185 (ite $x1876 $x2097 (and (and (ite $x1871 $x2097 (and (and $x2179 true $x2174))) true $x2174)))))
 (let (($x2188 (= t_wq3_0 (+ wq2 xn_q3))))
 (let (($x1882 (= f_q3 join)))
 (let (($x2190 (ite $x1882 (and $x2188 (and $x2185)) (ite $x1860 (ite $x1820 $x2097 (and $x2170)) $x2132))))
 (let (($x2191 (>= block_num_q3 block_num_q2)))
 (let (($x2192 (>= awq2_2 0)))
 (let (($x2193 (>= awq2_1 0)))
 (let (($x2194 (>= awq2_0 0)))
 ...
 (let (($x2512 (= par2q1 par2q2)))
 (let (($x2513 (= par1q1 par1q2)))
 (let (($x2514 (= deadlineq1 deadlineq2)))
 (let (($x2515 (= oracleq1 oracleq2)))
 (let (($x2201 (= awq2_2 t_awq2_1_2)))
 (let (($x2202 (= awq2_1 t_awq2_1_1)))
 (let (($x2203 (= awq2_0 t_awq2_1_0)))
 (let (($x2204 (and $x2203 $x2202 $x2201)))
 (let (($x2205 (= wq2 t_wq2_1)))
 (let (($x2516 (and $x2205 $x2204 $x2515 $x2514 $x2513 $x2512)))
 (let (($x2523 (and (ite (= par2q1 0) (= t_awq2_1_0 (+ t_awq2_0_0 1)) (= t_awq2_1_0 t_awq2_0_0)) (ite (= par2q1 1) (= t_awq2_1_1 (+ t_awq2_0_1 1)) (= t_awq2_1_1 t_awq2_0_1)) (ite (= par2q1 2) (= t_awq2_1_2 (+ t_awq2_0_2 1)) (= t_awq2_1_2 t_awq2_0_2)))))
 (let (($x2221 (= t_wq2_1 (- t_wq2_0 1))))
 (let (($x2529 (and (= awq2_0 awq1_0) (= awq2_1 awq1_1) (= awq2_2 awq1_2))))
 (let (($x2531 (and (= wq2 wq1) $x2529 $x2515 $x2514 $x2513 $x2512)))
 (let (($x2549 (and (ite (= par1q1 0) (= t_awq2_0_0 (+ awq1_0 1)) (= t_awq2_0_0 awq1_0)) (ite (= par1q1 1) (= t_awq2_0_1 (+ awq1_1 1)) (= t_awq2_0_1 awq1_1)) (ite (= par1q1 2) (= t_awq2_0_2 (+ awq1_2 1)) (= t_awq2_0_2 awq1_2)))))
 (let (($x2553 (and (and (= t_wq2_0 (- wq1 1)) $x2549) (and (ite $x483 $x2531 (and (and $x2221 $x2523) true $x2516)) true $x2516))))
 (let (($x2559 (ite (not (>= block_num_q1 deadlineq1)) $x2531 (and (and (ite $x483 $x2531 $x2553) true $x2516)))))
 (let (($x2563 (not (= wq1 2))))
 (let (($x2253 (= xn_q2 0)))
 (let (($x2254 (not $x2253)))
 (let (($x2566 (ite $x2254 $x2531 (and (ite $x2563 $x2531 (and (and $x2559 true $x2516)))))))
 (let (($x2256 (= awq2_2 t_awq2_0_2)))
 (let (($x2257 (= awq2_1 t_awq2_0_1)))
 (let (($x2258 (= awq2_0 t_awq2_0_0)))
 (let (($x2259 (and $x2258 $x2257 $x2256)))
 (let (($x2260 (= wq2 t_wq2_0)))
 (let (($x2567 (and $x2260 $x2259 $x2515 $x2514 $x2513 $x2512)))
 (let (($x2577 (and (ite (= win_winner2_q 0) (= t_awq2_0_0 (+ awq1_0 wq1)) (= t_awq2_0_0 awq1_0)) (ite (= win_winner2_q 1) (= t_awq2_0_1 (+ awq1_1 wq1)) (= t_awq2_0_1 awq1_1)) (ite (= win_winner2_q 2) (= t_awq2_0_2 (+ awq1_2 wq1)) (= t_awq2_0_2 awq1_2)))))
 (let (($x2584 (ite (not (>= wq1 0)) $x2531 (and (and (= t_wq2_0 (- wq1 wq1)) $x2577) true $x2567))))
 (let (($x2591 (ite (not (or (= win_winner2_q par1q1) (= win_winner2_q par2q1))) $x2531 (and (and $x2584 true $x2567)))))
 (let (($x2597 (and (ite (not (< block_num_q1 deadlineq1)) $x2531 (and (and $x2591 true $x2567))) true $x2567)))
 (let (($x2598 (and $x2597)))
 (let (($x2604 (ite $x2563 $x2531 (and (and (ite (not (= oracle_1 oracleq1)) $x2531 $x2598) true $x2567)))))
 (let (($x2294 (= f_q2 win)))
 (let (($x2296 (= t_par2q2_0 par2q2)))
 (let (($x2608 (and $x2260 $x2529 $x2515 $x2514 $x2513 $x2296)))
 (let (($x2613 (ite (not (and (distinct oracle_1 par1q1) true)) $x2531 (and (and (= t_par2q2_0 oracle_1) true $x2608)))))
 (let (($x2304 (= xn_q2 1)))
 (let (($x2305 (not $x2304)))
 (let (($x2309 (= t_wq2_0 1)))
 (let (($x2310 (not $x2309)))
 (let (($x2619 (ite $x2310 $x2531 (and (and (ite $x2305 $x2531 (and (and $x2613 true $x2608))) true $x2608)))))
 (let (($x2622 (= t_wq2_0 (+ wq1 xn_q2))))
 (let (($x2316 (= f_q2 join)))
 (let (($x2624 (ite $x2316 (and $x2622 (and $x2619)) (ite $x2294 (ite $x2254 $x2531 (and $x2604)) $x2566))))
 (let (($x2625 (>= block_num_q2 block_num_q1)))
 (let (($x2629 (and (>= awq1_0 0) (>= awq1_1 0) (>= awq1_2 0))))
 (let (($x2319 (>= xn_q2 0)))
 (let (($x2320 (and $x1124 $x1125 $x2319)))
 (let (($x2631 (not (and $x2320 $x2629 $x2625 $x2624))))
 (let (($x2946 (= par2q0 par2q1)))
 (let (($x2947 (= par1q0 par1q1)))
 (let (($x2948 (= deadlineq0 deadlineq1)))
 (let (($x2949 (= oracleq0 oracleq1)))
 (let (($x2638 (and (= awq1_0 t_awq1_1_0) (= awq1_1 t_awq1_1_1) (= awq1_2 t_awq1_1_2))))
 (let (($x2639 (= wq1 t_wq1_1)))
 (let (($x2950 (and $x2639 $x2638 $x2949 $x2948 $x2947 $x2946)))
 (let (($x2957 (and (ite (= par2q0 0) (= t_awq1_1_0 (+ t_awq1_0_0 1)) (= t_awq1_1_0 t_awq1_0_0)) (ite (= par2q0 1) (= t_awq1_1_1 (+ t_awq1_0_1 1)) (= t_awq1_1_1 t_awq1_0_1)) (ite (= par2q0 2) (= t_awq1_1_2 (+ t_awq1_0_2 1)) (= t_awq1_1_2 t_awq1_0_2)))))
 (let (($x2655 (= t_wq1_1 (- t_wq1_0 1))))
 (let (($x2963 (and (= awq1_0 awq0_0) (= awq1_1 awq0_1) (= awq1_2 awq0_2))))
 (let (($x2965 (and (= wq1 wq0) $x2963 $x2949 $x2948 $x2947 $x2946)))
 (let (($x2983 (and (ite (= par1q0 0) (= t_awq1_0_0 (+ awq0_0 1)) (= t_awq1_0_0 awq0_0)) (ite (= par1q0 1) (= t_awq1_0_1 (+ awq0_1 1)) (= t_awq1_0_1 awq0_1)) (ite (= par1q0 2) (= t_awq1_0_2 (+ awq0_2 1)) (= t_awq1_0_2 awq0_2)))))
 (let (($x2987 (and (and (= t_wq1_0 (- wq0 1)) $x2983) (and (ite $x483 $x2965 (and (and $x2655 $x2957) true $x2950)) true $x2950))))
 (let (($x2993 (ite (not (>= block_num_q0 deadlineq0)) $x2965 (and (and (ite $x483 $x2965 $x2987) true $x2950)))))
 (let (($x2997 (not (= wq0 2))))
 (let (($x2688 (not (= xn_q1 0))))
 (let (($x3000 (ite $x2688 $x2965 (and (ite $x2997 $x2965 (and (and $x2993 true $x2950)))))))
 (let (($x2693 (and (= awq1_0 t_awq1_0_0) (= awq1_1 t_awq1_0_1) (= awq1_2 t_awq1_0_2))))
 (let (($x2694 (= wq1 t_wq1_0)))
 (let (($x3001 (and $x2694 $x2693 $x2949 $x2948 $x2947 $x2946)))
 (let (($x3011 (and (ite (= win_winner1_q 0) (= t_awq1_0_0 (+ awq0_0 wq0)) (= t_awq1_0_0 awq0_0)) (ite (= win_winner1_q 1) (= t_awq1_0_1 (+ awq0_1 wq0)) (= t_awq1_0_1 awq0_1)) (ite (= win_winner1_q 2) (= t_awq1_0_2 (+ awq0_2 wq0)) (= t_awq1_0_2 awq0_2)))))
 (let (($x3018 (ite (not (>= wq0 0)) $x2965 (and (and (= t_wq1_0 (- wq0 wq0)) $x3011) true $x3001))))
 (let (($x3025 (ite (not (or (= win_winner1_q par1q0) (= win_winner1_q par2q0))) $x2965 (and (and $x3018 true $x3001)))))
 (let (($x3031 (and (ite (not (< block_num_q0 deadlineq0)) $x2965 (and (and $x3025 true $x3001))) true $x3001)))
 (let (($x3032 (and $x3031)))
 (let (($x3038 (ite $x2997 $x2965 (and (and (ite (not (= oracle_1 oracleq0)) $x2965 $x3032) true $x3001)))))
 (let (($x2728 (= f_q1 win)))
 (let (($x2730 (= t_par2q1_0 par2q1)))
 (let (($x3042 (and $x2694 $x2963 $x2949 $x2948 $x2947 $x2730)))
 (let (($x3047 (ite (not (and (distinct oracle_1 par1q0) true)) $x2965 (and (and (= t_par2q1_0 oracle_1) true $x3042)))))
 (let (($x2739 (not (= xn_q1 1))))
 (let (($x2744 (not (= t_wq1_0 1))))
 (let (($x3053 (ite $x2744 $x2965 (and (and (ite $x2739 $x2965 (and (and $x3047 true $x3042))) true $x3042)))))
 (let (($x3056 (= t_wq1_0 (+ wq0 xn_q1))))
 (let (($x2750 (= f_q1 join)))
 (let (($x3058 (ite $x2750 (and $x3056 (and $x3053)) (ite $x2728 (ite $x2688 $x2965 (and $x3038)) $x3000))))
 (let (($x3059 (>= block_num_q1 block_num_q0)))
 (let (($x3063 (and (>= awq0_0 0) (>= awq0_1 0) (>= awq0_2 0))))
 (let (($x2753 (>= xn_q1 0)))
 (let (($x2754 (and $x1124 $x1125 $x2753)))
 (let (($x3066 (= par2_1 par2q0)))
 (let (($x3067 (= par1_1 par1q0)))
 (let (($x3068 (= deadline_1 deadlineq0)))
 (let (($x3033 (= oracle_1 oracleq0)))
 (let (($x3072 (and (= awq0_0 t_awq0_1_0) (= awq0_1 t_awq0_1_1) (= awq0_2 t_awq0_1_2))))
 (let (($x3073 (= wq0 t_wq0_1)))
 (let (($x3074 (and $x3073 $x3072 $x3033 $x3068 $x3067 $x3066)))
 (let (($x3087 (and (ite (= par2_1 0) (= t_awq0_1_0 (+ t_awq0_0_0 1)) (= t_awq0_1_0 t_awq0_0_0)) (ite (= par2_1 1) (= t_awq0_1_1 (+ t_awq0_0_1 1)) (= t_awq0_1_1 t_awq0_0_1)) (ite (= par2_1 2) (= t_awq0_1_2 (+ t_awq0_0_2 1)) (= t_awq0_1_2 t_awq0_0_2)))))
 (let (($x3089 (= t_wq0_1 (- t_wq0_0 1))))
 (let (($x3095 (and (= awq0_0 aw_1_0) (= awq0_1 aw_1_1) (= awq0_2 aw_1_2))))
 (let (($x3097 (and (= wq0 w_1) $x3095 $x3033 $x3068 $x3067 $x3066)))
 (let (($x3100 (= t_awq0_0_2 aw_1_2)))
 (let (($x494 (= par1_1 2)))
 (let (($x3103 (= t_awq0_0_1 aw_1_1)))
 (let (($x490 (= par1_1 1)))
 (let (($x3106 (= t_awq0_0_0 aw_1_0)))
 (let (($x486 (= par1_1 0)))
 (let (($x3109 (and (ite $x486 (= t_awq0_0_0 (+ aw_1_0 1)) $x3106) (ite $x490 (= t_awq0_0_1 (+ aw_1_1 1)) $x3103) (ite $x494 (= t_awq0_0_2 (+ aw_1_2 1)) $x3100))))
 (let (($x3112 (and (and (= t_wq0_0 (- w_1 1)) $x3109) (and (ite $x483 $x3097 (and (and $x3089 $x3087) true $x3074)) true $x3074))))
 (let (($x482 (not (>= block_num_1 deadline_1))))
 (let (($x3117 (and (ite $x482 $x3097 (and (and (ite $x483 $x3097 $x3112) true $x3074))) true $x3074)))
 (let (($x429 (= w_1 2)))
 (let (($x430 (not $x429)))
 (let (($x3122 (not (= xn_q0 0))))
 (let (($x3127 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2))))
 (let (($x3128 (= wq0 t_wq0_0)))
 (let (($x3129 (and $x3128 $x3127 $x3033 $x3068 $x3067 $x3066)))
 (let (($x3139 (and (ite (= win_winner0_q 0) (= t_awq0_0_0 (+ aw_1_0 w_1)) $x3106) (ite (= win_winner0_q 1) (= t_awq0_0_1 (+ aw_1_1 w_1)) $x3103) (ite (= win_winner0_q 2) (= t_awq0_0_2 (+ aw_1_2 w_1)) $x3100))))
 (let (($x439 (>= w_1 0)))
 (let (($x440 (not $x439)))
 (let (($x3143 (ite $x440 $x3097 (and (and (= t_wq0_0 (- w_1 w_1)) $x3139) true $x3129))))
 (let (($x3150 (ite (not (or (= win_winner0_q par1_1) (= win_winner0_q par2_1))) $x3097 (and (and $x3143 true $x3129)))))
 (let (($x433 (< block_num_1 deadline_1)))
 (let (($x434 (not $x433)))
 (let (($x1167 (not (= oracle_1 oracle_1))))
 (let (($x3156 (ite $x1167 $x3097 (and (and (ite $x434 $x3097 (and (and $x3150 true $x3129))) true $x3129)))))
 (let (($x3162 (= f_q0 win)))
 (let (($x3163 (ite $x3162 (ite $x3122 $x3097 (and (ite $x430 $x3097 (and (and $x3156 true $x3129))))) (ite $x3122 $x3097 (and (ite $x430 $x3097 (and $x3117)))))))
 (let (($x3164 (= t_par2q0_0 par2q0)))
 (let (($x3165 (and $x3128 $x3095 $x3033 $x3068 $x3067 $x3164)))
 (let (($x1147 (not (and (distinct oracle_1 par1_1) true))))
 (let (($x3170 (and (ite $x1147 $x3097 (and (and (= t_par2q0_0 oracle_1) true $x3165))) true $x3165)))
 (let (($x3173 (not (= xn_q0 1))))
 (let (($x3178 (not (= t_wq0_0 1))))
 (let (($x3180 (and (ite $x3178 $x3097 (and (and (ite $x3173 $x3097 (and $x3170)) true $x3165))))))
 (let (($x3184 (= f_q0 join)))
 (let (($x389 (>= aw_1_2 0)))
 (let (($x388 (>= aw_1_1 0)))
 (let (($x387 (>= aw_1_0 0)))
 (let (($x390 (and $x387 $x388 $x389)))
 (let (($x3189 (and (and $x1124 $x1125 (>= xn_q0 0)) $x390 (>= block_num_q0 block_num_1) (ite $x3184 (and (= t_wq0_0 (+ w_1 xn_q0)) $x3180) $x3163))))
 (or (not $x3189) (not (and $x2754 $x3063 $x3059 $x3058)) $x2631 $x2197 $x1763 $x1326)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x429 (= w_1 2)))
 (let (($x433 (< block_num_1 deadline_1)))

...
(assert
 (let (($x1013 (exists ((xa_q Int) )(let (($x660 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (bq0 Bool) (t_bq0_0 Bool) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (block_num_q1 Int) (pay_amount1_q Int) (bq1 Bool) (t_bq1_0 Bool) )(let (($x924 (and (or (and (distinct xa_q 0) true) (not (= awq1_0 (+ aw_3_0 w_3)))) (or (and (distinct xa_q 1) true) (not (= awq1_1 (+ aw_3_1 w_3)))) (or (and (distinct xa_q 2) true) (not (= awq1_2 (+ aw_3_2 w_3)))))))
 (let (($x580 (= t_bq1_0 bq1)))
 (let (($x585 (= wq1 t_wq1_0)))
 (let (($x586 (and $x585 (and (= awq1_0 t_awq1_0_0) (= awq1_1 t_awq1_0_1) (= awq1_2 t_awq1_0_2)) $x580)))
 (let (($x625 (and (ite (= xa_q 0) (= t_awq1_0_0 (+ awq0_0 pay_amount1_q)) (= t_awq1_0_0 awq0_0)) (ite (= xa_q 1) (= t_awq1_0_1 (+ awq0_1 pay_amount1_q)) (= t_awq1_0_1 awq0_1)) (ite (= xa_q 2) (= t_awq1_0_2 (+ awq0_2 pay_amount1_q)) (= t_awq1_0_2 awq0_2)))))
 (let (($x759 (= bq0 bq1)))
 (let (($x760 (= awq1_2 awq0_2)))
 (let (($x761 (= awq1_1 awq0_1)))
 (let (($x762 (= awq1_0 awq0_0)))
 (let (($x763 (and $x762 $x761 $x760)))
 (let (($x764 (= wq1 wq0)))
 (let (($x765 (and $x764 $x763 $x759)))
 (let (($x611 (>= pay_amount1_q 0)))
 (let (($x612 (not $x611)))
 (let (($x614 (= t_bq1_0 false)))
 (let (($x539 (and $x614 (ite $x612 $x765 (and (and (= t_wq1_0 (- wq0 pay_amount1_q)) $x625) true $x586)))))
 (let (($x575 (ite (not (and (<= pay_amount1_q wq0) bq0)) $x765 (and (and $x539 true $x586)))))
 (let (($x623 (= xn_q1 0)))
 (let (($x624 (not $x623)))
 (let (($x781 (ite (not (not bq0)) $x765 (and (and (= t_bq1_0 true) true (and $x764 $x763 $x580))))))
 (let (($x633 (= f_q1 unlock)))
 (let (($x519 (and (and (>= xa_q 0) (<= xa_q 2) (>= xn_q1 0)) (and (>= awq0_0 0) (>= awq0_1 0) (>= awq0_2 0)) (>= block_num_q1 block_num_q0) (ite $x633 (ite $x624 $x765 (and $x781)) (ite $x624 $x765 (and $x575))))))
 (let (($x520 (not $x519)))
 (let (($x793 (= t_bq0_0 bq0)))
 (let (($x798 (= wq0 t_wq0_0)))
 (let (($x799 (and $x798 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2)) $x793)))
 (let (($x876 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_3_0 pay_amount0_q)) (= t_awq0_0_0 aw_3_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_3_1 pay_amount0_q)) (= t_awq0_0_1 aw_3_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_3_2 pay_amount0_q)) (= t_awq0_0_2 aw_3_2)))))
 (let (($x1084 (= b_3 bq0)))
 (let (($x1085 (= awq0_2 aw_3_2)))
 (let (($x1086 (= awq0_1 aw_3_1)))
 (let (($x1087 (= awq0_0 aw_3_0)))
 (let (($x1088 (and $x1087 $x1086 $x1085)))
 (let (($x1089 (= wq0 w_3)))
 (let (($x1090 (and $x1089 $x1088 $x1084)))
 (let (($x824 (>= pay_amount0_q 0)))
 (let (($x825 (not $x824)))
 (let (($x827 (= t_bq0_0 false)))
 (let (($x887 (and $x827 (ite $x825 $x1090 (and (and (= t_wq0_0 (- w_3 pay_amount0_q)) $x876) true $x799)))))
 (let (($x893 (ite (not (and (<= pay_amount0_q w_3) b_3)) $x1090 (and (and $x887 true $x799)))))
 (let (($x836 (= xn_q0 0)))
 (let (($x837 (not $x836)))
 (let (($x388 (not b_3)))
 (let (($x389 (not $x388)))
 (let (($x1104 (ite $x389 $x1090 (and (and (= t_bq0_0 true) true (and $x1089 $x1088 $x793))))))
 (let (($x846 (= f_q0 unlock)))
 (let (($x375 (>= aw_3_2 0)))
 (let (($x374 (>= aw_3_1 0)))
 (let (($x373 (>= aw_3_0 0)))
 (let (($x376 (and $x373 $x374 $x375)))
 ...
 (let (($x640 (<= xa_q 2)))
 (let (($x641 (>= xa_q 0)))
 (let (($x537 (and $x641 $x640 $x849)))
 (let (($x548 (and $x537 $x376 (>= block_num_q0 block_num_3) (ite $x846 (ite $x837 $x1090 (and $x1104)) (ite $x837 $x1090 (and $x893))))))
 (or (not $x548) $x520 $x924))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x512 (<= xa_q 2)))
 (let (($x513 (>= xa_q 0)))

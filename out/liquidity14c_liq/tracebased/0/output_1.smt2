...
(assert
 (let (($x1065 (exists ((xa_q Int) )(let (($x543 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (bq0 Bool) (t_bq0_0 Bool) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (block_num_q1 Int) (pay_amount1_q Int) (bq1 Bool) (t_bq1_0 Bool) )(let (($x603 (and (or (and (distinct xa_q 0) true) (not (= awq1_0 (+ aw_1_0 w_1)))) (or (and (distinct xa_q 1) true) (not (= awq1_1 (+ aw_1_1 w_1)))) (or (and (distinct xa_q 2) true) (not (= awq1_2 (+ aw_1_2 w_1)))))))
 ...
 (let (($x525 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_1_0 pay_amount0_q)) (= t_awq0_0_0 aw_1_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_1_1 pay_amount0_q)) (= t_awq0_0_1 aw_1_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_1_2 pay_amount0_q)) (= t_awq0_0_2 aw_1_2)))))
 (let (($x817 (= b_1 bq0)))
 (let (($x818 (= awq0_2 aw_1_2)))
 (let (($x819 (= awq0_1 aw_1_1)))
 (let (($x820 (= awq0_0 aw_1_0)))
 (let (($x821 (and $x820 $x819 $x818)))
 (let (($x822 (= wq0 w_1)))
 (let (($x823 (and $x822 $x821 $x817)))
 (let (($x824 (>= pay_amount0_q 0)))
 (let (($x825 (not $x824)))
 (let (($x827 (= t_bq0_0 false)))
 (let (($x530 (and $x827 (ite $x825 $x823 (and (and (= t_wq0_0 (- w_1 pay_amount0_q)) $x525) true $x799)))))
 (let (($x533 (ite (not (and (<= pay_amount0_q w_1) b_1)) $x823 (and (and $x530 true $x799)))))
 (let (($x836 (= xn_q0 0)))
 (let (($x837 (not $x836)))
 (let (($x180 (not b_1)))
 (let (($x181 (not $x180)))
 (let (($x843 (ite $x181 $x823 (and (and (= t_bq0_0 true) true (and $x822 $x821 $x793))))))
 ...
 (let (($x538 (and $x537 $x168 (>= block_num_q0 block_num_1) (ite $x846 (ite $x837 $x823 (and $x843)) (ite $x837 $x823 (and $x533))))))
 (or (not $x538) $x520 $x603))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x512 (<= xa_q 2)))
 (let (($x513 (>= xa_q 0)))

...
(assert
 (let (($x1083 (exists ((xa_q Int) )(let (($x754 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (bq0 Bool) (t_bq0_0 Bool) )(let (($x803 (and (or (and (distinct xa_q 0) true) (not (= awq0_0 (+ aw_2_0 w_2)))) (or (and (distinct xa_q 1) true) (not (= awq0_1 (+ aw_2_1 w_2)))) (or (and (distinct xa_q 2) true) (not (= awq0_2 (+ aw_2_2 w_2)))))))
 (let (($x580 (= t_bq0_0 bq0)))
 (let (($x585 (= wq0 t_wq0_0)))
 (let (($x586 (and $x585 (and (= awq0_0 t_awq0_0_0) (= awq0_1 t_awq0_0_1) (= awq0_2 t_awq0_0_2)) $x580)))
 (let (($x826 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_2_0 pay_amount0_q)) (= t_awq0_0_0 aw_2_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_2_1 pay_amount0_q)) (= t_awq0_0_1 aw_2_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_2_2 pay_amount0_q)) (= t_awq0_0_2 aw_2_2)))))
 (let (($x698 (= b_2 bq0)))
 (let (($x699 (= awq0_2 aw_2_2)))
 (let (($x700 (= awq0_1 aw_2_1)))
 (let (($x701 (= awq0_0 aw_2_0)))
 (let (($x702 (and $x701 $x700 $x699)))
 (let (($x703 (= wq0 w_2)))
 (let (($x704 (and $x703 $x702 $x698)))
 (let (($x611 (>= pay_amount0_q 0)))
 (let (($x612 (not $x611)))
 (let (($x614 (= t_bq0_0 false)))
 (let (($x834 (and $x614 (ite $x612 $x704 (and (and (= t_wq0_0 (- w_2 pay_amount0_q)) $x826) true $x586)))))
 (let (($x847 (ite (not (and (<= pay_amount0_q w_2) b_2)) $x704 (and (and $x834 true $x586)))))
 (let (($x623 (= xn_q0 0)))
 (let (($x624 (not $x623)))
 (let (($x285 (not b_2)))
 (let (($x286 (not $x285)))
 (let (($x721 (ite $x286 $x704 (and (and (= t_bq0_0 true) true (and $x703 $x702 $x580))))))
 ...
 (let (($x753 (and $x506 $x273 (>= block_num_q0 block_num_2) (ite $x633 (ite $x624 $x704 (and $x721)) (ite $x624 $x704 (and $x847))))))
 (or (not $x753) $x803))))))))))))))))))))))))))))))))))
 ))
 (let (($x512 (<= xa_q 2)))
 (let (($x513 (>= xa_q 0)))

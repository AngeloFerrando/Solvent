...
(assert
 (let (($x1121 (exists ((xa_q Int) )(let (($x676 (forall ((xn_q0 Int) (f_q0 Proc) (wq0 Int) (awq0_0 Int) (awq0_1 Int) (awq0_2 Int) (t_wq0_0 Int) (t_awq0_0_0 Int) (t_awq0_0_1 Int) (t_awq0_0_2 Int) (block_num_q0 Int) (pay_amount0_q Int) (bq0 Bool) (t_bq0_0 Bool) (xn_q1 Int) (f_q1 Proc) (wq1 Int) (awq1_0 Int) (awq1_1 Int) (awq1_2 Int) (t_wq1_0 Int) (t_awq1_0_0 Int) (t_awq1_0_1 Int) (t_awq1_0_2 Int) (block_num_q1 Int) (pay_amount1_q Int) (bq1 Bool) (t_bq1_0 Bool) )(let (($x718 (and (or (and (distinct xa_q 0) true) (not (= awq1_0 (+ aw_2_0 w_2)))) (or (and (distinct xa_q 1) true) (not (= awq1_1 (+ aw_2_1 w_2)))) (or (and (distinct xa_q 2) true) (not (= awq1_2 (+ aw_2_2 w_2)))))))
 ...
 (let (($x697 (and (ite (= xa_q 0) (= t_awq0_0_0 (+ aw_2_0 pay_amount0_q)) (= t_awq0_0_0 aw_2_0)) (ite (= xa_q 1) (= t_awq0_0_1 (+ aw_2_1 pay_amount0_q)) (= t_awq0_0_1 aw_2_1)) (ite (= xa_q 2) (= t_awq0_0_2 (+ aw_2_2 pay_amount0_q)) (= t_awq0_0_2 aw_2_2)))))
 (let (($x968 (= b_2 bq0)))
 (let (($x969 (= awq0_2 aw_2_2)))
 (let (($x970 (= awq0_1 aw_2_1)))
 (let (($x971 (= awq0_0 aw_2_0)))
 (let (($x972 (and $x971 $x970 $x969)))
 (let (($x973 (= wq0 w_2)))
 (let (($x974 (and $x973 $x972 $x968)))
 (let (($x824 (>= pay_amount0_q 0)))
 (let (($x825 (not $x824)))
 (let (($x827 (= t_bq0_0 false)))
 (let (($x708 (and $x827 (ite $x825 $x974 (and (and (= t_wq0_0 (- w_2 pay_amount0_q)) $x697) true $x799)))))
 (let (($x716 (ite (not (and (<= pay_amount0_q w_2) b_2)) $x974 (and (and $x708 true $x799)))))
 (let (($x836 (= xn_q0 0)))
 (let (($x837 (not $x836)))
 (let (($x285 (not b_2)))
 (let (($x286 (not $x285)))
 (let (($x988 (ite $x286 $x974 (and (and (= t_bq0_0 true) true (and $x973 $x972 $x793))))))
 ...
 (let (($x661 (and $x537 $x273 (>= block_num_q0 block_num_2) (ite $x846 (ite $x837 $x974 (and $x988)) (ite $x837 $x974 (and $x716))))))
 (or (not $x661) $x520 $x718))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 ))
 (let (($x512 (<= xa_q 2)))
 (let (($x513 (>= xa_q 0)))
